	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 lerpResult142 = lerp( SAMPLE_TEXTURE2D( _Overlay, sampler_Overlay, ( ( (SAMPLE_TEXTURE2D( _NoiseMap, sampler_NoiseMap, ( appendResult10_g48 + appendResult24_g48 ) )).rg * _NoiseMapStrength ) + ( float2( 1,1 ) * appendResult58_g48 ) ) ) , SAMPLE_TEXTURE2D( _Base, sampler_Base, uv_Base ) , clampResult147);
				...
				float4 tex2DNode37 = SAMPLE_TEXTURE2D( _RGB, sampler_RGB, ( texCoord38 * float2( 350,350 ) ) );
				...
				surfaceDescription.Emission = ( clampResult55 * _Tint ).xyz;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 temp_output_1_0_g48 = _NoiseMapSize;
				float2 texCoord80_g48 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult10_g48 = (float2(( (temp_output_1_0_g48).x * texCoord80_g48.x ) , ( texCoord80_g48.y * (temp_output_1_0_g48).y )));
				float2 temp_output_11_0_g48 = _NoiseMapPannerSpeed;
				float2 texCoord81_g48 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner18_g48 = ( ( (temp_output_11_0_g48).x * _TimeParameters.x ) * float2( 1,0 ) + texCoord81_g48);
				float2 panner19_g48 = ( ( _TimeParameters.x * (temp_output_11_0_g48).y ) * float2( 0,1 ) + texCoord81_g48);
				float2 appendResult24_g48 = (float2((panner18_g48).x , (panner19_g48).y));
				float2 temp_output_47_0_g48 = _RingPannerSpeed;
				float2 texCoord78_g48 = packedInput.ase_texcoord.xy * float2( 2,2 ) + float2( 0,0 );
				float2 temp_output_31_0_g48 = ( texCoord78_g48 - float2( 1,1 ) );
				float2 appendResult39_g48 = (float2(frac( ( atan2( (temp_output_31_0_g48).x , (temp_output_31_0_g48).y ) / TWO_PI ) ) , length( temp_output_31_0_g48 )));
				float2 panner54_g48 = ( ( (temp_output_47_0_g48).x * _TimeParameters.x ) * float2( 1,0 ) + appendResult39_g48);
				float2 panner55_g48 = ( ( _TimeParameters.x * (temp_output_47_0_g48).y ) * float2( 0,1 ) + appendResult39_g48);
...
/*ASEBEGIN
Version=18920
303;172;1497;869;-611.2776;1987.833;2.766084;True;False
Node;AmplifyShaderEditor.Vector2Node;140;-264.2746,-283.0395;Float;False;Property;_NoiseMapSize;NoiseMapSize;8;0;Create;True;0;0;0;False;0;False;512,512;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;136;-305.6404,-153.733;Float;False;Property;_NoiseMapPannerSpeed;NoiseMapPannerSpeed;10;0;Create;True;0;0;0;False;0;False;0,0;0.2,0.1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;39;1024.25,213.8401;Inherit;False;Constant;_Vector1;Vector 1;0;0;Create;True;0;0;0;False;0;False;350,350;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SamplerNode;37;1394.1,115.54;Inherit;True;Property;_RGB;RGB;3;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;49;1910.72,288.9221;Inherit;False;Property;_Intensity;Intensity;5;0;Create;True;0;0;0;False;0;False;20;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;162;2535.082,-377.1044;Inherit;False;Property;_Tint;Tint;11;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;2.973807,1.725369,1.902146,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;93;2416.339,-74.26453;Inherit;False;Property;_Specular;Specular;7;0;Create;True;0;0;0;False;0;False;0;0.685;0;1;0;1;FLOAT;0
...
WireConnection;102;6;160;0
WireConnection;102;7;94;0
ASEEND*/
//CHKSM=9D7709D6AD3D9B7068AF191EA2006F9BF1B44C12