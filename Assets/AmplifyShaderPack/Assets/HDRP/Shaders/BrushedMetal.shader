	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_BrushedMetalSpecular = packedInput.ase_texcoord5.xy * _BrushedMetalSpecular_ST.xy + _BrushedMetalSpecular_ST.zw;
				
				float2 uv_BrushedMetalNormal = packedInput.ase_texcoord5.xy * _BrushedMetalNormal_ST.xy + _BrushedMetalNormal_ST.zw;
				
				surfaceDescription.Albedo = SAMPLE_TEXTURE2D( _BrushedMetalSpecular, sampler_BrushedMetalSpecular, uv_BrushedMetalSpecular ).rgb;
				surfaceDescription.Normal = UnpackNormalScale( SAMPLE_TEXTURE2D( _BrushedMetalNormal, sampler_BrushedMetalNormal, uv_BrushedMetalNormal ), 1.0f );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_BrushedMetalSpecular = packedInput.ase_texcoord.xy * _BrushedMetalSpecular_ST.xy + _BrushedMetalSpecular_ST.zw;
				
				float2 uv_BrushedMetalNormal = packedInput.ase_texcoord.xy * _BrushedMetalNormal_ST.xy + _BrushedMetalNormal_ST.zw;
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_BrushedMetalNormal = packedInput.ase_texcoord3.xy * _BrushedMetalNormal_ST.xy + _BrushedMetalNormal_ST.zw;
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_BrushedMetalSpecular = packedInput.ase_texcoord7.xy * _BrushedMetalSpecular_ST.xy + _BrushedMetalSpecular_ST.zw;
				
				float2 uv_BrushedMetalNormal = packedInput.ase_texcoord7.xy * _BrushedMetalNormal_ST.xy + _BrushedMetalNormal_ST.zw;
...
/*ASEBEGIN
Version=18920
303;172;1497;869;1258.51;466.1651;1.005;True;False
...
ASEEND*/
//CHKSM=C259E376434A693EB0C94D7E663930A55BCD8B7F