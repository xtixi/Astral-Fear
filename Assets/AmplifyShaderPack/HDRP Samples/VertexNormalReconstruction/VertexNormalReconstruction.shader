...
Shader "AmplifyShaderPack/HDRP/VertexNormalReconstruction"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 break3_g17 = inputMesh.positionOS;
				float frequency291 = _Frequency;
				float mulTime4_g17 = _TimeParameters.x * 2.0;
				float amplitude287 = _Amplitude;
				float3 appendResult11_g17 = (float3(break3_g17.x , ( break3_g17.y + ( sin( ( ( break3_g17.x * frequency291 ) + mulTime4_g17 ) ) * ( amplitude287 * inputMesh.ase_texcoord.x ) ) ) , break3_g17.z));
				...
				float3 break3_g16 = mul( ( appendResult198 + mul( ObjectToTangent121, inputMesh.positionOS ) ), ObjectToTangent121 );
				float mulTime4_g16 = _TimeParameters.x * 2.0;
				float3 appendResult11_g16 = (float3(break3_g16.x , ( break3_g16.y + ( sin( ( ( break3_g16.x * frequency291 ) + mulTime4_g16 ) ) * ( amplitude287 * inputMesh.ase_texcoord.x ) ) ) , break3_g16.z));
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float mulTime4_g17 = _TimeParameters.x * 2.0;
				float amplitude287 = _Amplitude;
				float3 appendResult11_g17 = (float3(break3_g17.x , ( break3_g17.y + ( sin( ( ( break3_g17.x * frequency291 ) + mulTime4_g17 ) ) * ( amplitude287 * inputMesh.uv0.x ) ) ) , break3_g17.z));
				float3 newVertexPos56 = appendResult11_g17;
				...
				float3 break3_g16 = mul( ( appendResult198 + mul( ObjectToTangent121, inputMesh.positionOS ) ), ObjectToTangent121 );
				float mulTime4_g16 = _TimeParameters.x * 2.0;
				float3 appendResult11_g16 = (float3(break3_g16.x , ( break3_g16.y + ( sin( ( ( break3_g16.x * frequency291 ) + mulTime4_g16 ) ) * ( amplitude287 * inputMesh.uv0.x ) ) ) , break3_g16.z));
				float3 xDeviation113 = appendResult11_g16;
				float3 normalizeResult97 = normalize( cross( ( yDeviation114 - newVertexPos56 ) , ( xDeviation113 - newVertexPos56 ) ) );
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_Flagalbedo = packedInput.ase_texcoord.xy * _Flagalbedo_ST.xy + _Flagalbedo_ST.zw;
				float3 temp_cast_0 = (pow( tex2D( _Flagalbedo, uv_Flagalbedo ).r , 2.0 )).xxx;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float deviation199 = _Normalpositiondeviation;
				float3 appendResult206 = (float3(0.0 , deviation199 , 0.0));
				float3x3 ObjectToTangent121 = float3x3(cross( inputMesh.normalOS , inputMesh.ase_tangent.xyz ), inputMesh.ase_tangent.xyz, inputMesh.normalOS);
				float3 break3_g18 = mul( ( appendResult206 + mul( ObjectToTangent121, inputMesh.positionOS ) ), ObjectToTangent121 );
				float mulTime4_g18 = _TimeParameters.x * 2.0;
				float3 appendResult11_g18 = (float3(break3_g18.x , ( break3_g18.y + ( sin( ( ( break3_g18.x * frequency291 ) + mulTime4_g18 ) ) * ( amplitude287 * inputMesh.ase_texcoord.x ) ) ) , break3_g18.z));
				float3 yDeviation114 = appendResult11_g18;
...
/*ASEBEGIN
Version=18920
303;172;1497;869;-743.604;1322.034;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;314;-432,-368;Inherit;False;Waving Vertex;-1;;16;92011dd32a987944ab174f5e78047379;0;3;1;FLOAT3;0,0,0;False;12;FLOAT;0;False;13;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SamplerNode;305;1277.821,-1067.025;Inherit;True;Property;_Flagalbedo;Flag albedo;3;0;Create;True;0;0;0;False;0;False;-1;None;aab8de1052c54173b3d61e7f8b05aedf;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;331;7;19;0
WireConnection;331;11;109;0
WireConnection;331;12;97;0
ASEEND*/
//CHKSM=05BE77BF4D904FFD76FBD98B04485603090BD5F1