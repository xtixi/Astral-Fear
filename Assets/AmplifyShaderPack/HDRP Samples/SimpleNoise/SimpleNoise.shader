...
Shader "AmplifyShaderPack/HDRP/SimpleNoise"
{
	Properties
	{
		...
		[ASEEnd]_Strength("Strength", Range( 0 , 0.1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				surfaceDescription.Albedo = SAMPLE_TEXTURE2D( _MainTexture, sampler_MainTexture, ( uv_MainTexture + ( simplePerlin2D205 * _Strength ) ) ).rgb;
...
/*ASEBEGIN
Version=18920
303;172;1497;869;-1551.086;518.1463;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;211;1538.458,108.999;Float;False;Property;_Strength;Strength;2;0;Create;True;0;0;0;False;0;False;0;0.025;0;0.1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=CBC2A504F0C2069F339E420DDB84F3DE0E298F9F