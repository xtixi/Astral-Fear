...
Shader "AmplifyShaderPack/HDRP/2D Fractal"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float2 texCoord4 = packedInput.ase_texcoord1.xy * float2( 2,2 ) + float2( -1,-1 );
				...
				surfaceDescription.Color = ( _Tint * float4( hsvTorgb23 , 0.0 ) ).rgb;
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float saferPower25 = abs( _ZoomBase );
				float2 texCoord4 = packedInput.ase_texcoord.xy * float2( 2,2 ) + float2( -1,-1 );
				float2 UV3 = ( ( pow( saferPower25 , (sin( _TimeParameters.x * 0.5 )*_ZoomScale + _ZoomOffset) ) * texCoord4 ) + _Center );
				int MaxIter3 = _MaxIter;
				float Threshold3 = _Threshold;
				float localMandlebrot3 = Mandlebrot3( UV3 , MaxIter3 , Threshold3 );
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float saferPower25 = abs( _ZoomBase );
				float2 texCoord4 = packedInput.ase_texcoord3.xy * float2( 2,2 ) + float2( -1,-1 );
				float2 UV3 = ( ( pow( saferPower25 , (sin( _TimeParameters.x * 0.5 )*_ZoomScale + _ZoomOffset) ) * texCoord4 ) + _Center );
				int MaxIter3 = _MaxIter;
				float Threshold3 = _Threshold;
				float localMandlebrot3 = Mandlebrot3( UV3 , MaxIter3 , Threshold3 );
...
/*ASEBEGIN
Version=18920
303;172;1497;869;80.31171;1075.7;1.784552;True;False
...
Node;AmplifyShaderEditor.ColorNode;50;1209.487,-624.3115;Inherit;False;Property;_Tint;Tint;6;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;1.314039,0.9727036,0.923546,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=C08F6D1F22FEE0B84A795831AF9195060CDDF3E7