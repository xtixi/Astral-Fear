...
Shader "AmplifyShaderPack/HDRP/EnvironmentGradient"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			#endif
			CBUFFER_END
			TEXTURE2D(_R_AO_G_Edges);
			SAMPLER(sampler_R_AO_G_Edges);
						...
						)
			{
				...
				float4 tex2DNode13 = SAMPLE_TEXTURE2D( _R_AO_G_Edges, sampler_R_AO_G_Edges, texCoord11 );
				...
				surfaceDescription.Albedo = clampResult42.rgb;
				surfaceDescription.Normal = UnpackNormalScale( SAMPLE_TEXTURE2D( _NormalMap, sampler_NormalMap, texCoord11 ), 1.0f );
...
/*ASEBEGIN
Version=18920
303;172;1497;869;-687.977;239.3352;1;True;False
...
ASEEND*/
//CHKSM=F971D4562C68A8DA04DB0365A3B5780780CAD3EA