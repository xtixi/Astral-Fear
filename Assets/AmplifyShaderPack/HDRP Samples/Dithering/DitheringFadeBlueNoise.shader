...
Shader "AmplifyShaderPack/HDRP/Dithering Fade Blue Noise"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				surfaceDescription.Normal = UnpackNormalScale( SAMPLE_TEXTURE2D( _Normal, sampler_Normal, uv_Albedo ), 1.0f );
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = 0;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = SAMPLE_TEXTURE2D( _Specular, sampler_Specular, uv_Albedo ).rgb;
				#endif

				surfaceDescription.Emission = 0;
				surfaceDescription.Smoothness = 0.5;
				surfaceDescription.Occlusion = SAMPLE_TEXTURE2D( _Occlusion, sampler_Occlusion, uv_Albedo ).r;
...
/*ASEBEGIN
Version=18920
303;172;1497;869;1114.129;541.6772;1.779177;True;False
...
WireConnection;74;5;67;0
WireConnection;74;8;49;0
WireConnection;74;9;86;0
WireConnection;74;10;85;0
ASEEND*/
//CHKSM=61087AA667573089C653A94C8F0461C7EA7088CE