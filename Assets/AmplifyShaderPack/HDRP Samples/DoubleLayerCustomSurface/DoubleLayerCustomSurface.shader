...
Shader "AmplifyShaderPack/HDRP/Double Layer Custom Surface"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_FlakesRGBcolorvariationAmask = packedInput.ase_texcoord5.xy * _FlakesRGBcolorvariationAmask_ST.xy + _FlakesRGBcolorvariationAmask_ST.zw;
				...
				float fresnelNdotV279 = dot( normalWS, V );
				float fresnelNode279 = ( 0.05 + 1.0 * pow( 1.0 - fresnelNdotV279, 5.0 ) );
				float lerpResult306 = lerp( packedInput.ase_color.r , 1.0 , _BaseOcclusion);
				...
				surfaceDescription.Albedo = lerpResult345.rgb;
				surfaceDescription.Normal = lerpResult208;
				...
				surfaceDescription.Smoothness = saturate( ( lerpResult351 * _SmoothnessMultiplier ) );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 lerpResult278 = lerp( _BaseColor1 , _BaseColor2 , fresnelNode201);
				float4 lerpResult277 = lerp( _FlakesColor1 , _FlakesColor2 , fresnelNode201);
				float2 uv_FlakesRGBcolorvariationAmask = packedInput.ase_texcoord2.xy * _FlakesRGBcolorvariationAmask_ST.xy + _FlakesRGBcolorvariationAmask_ST.zw;
				float4 tex2DNode228 = tex2D( _FlakesRGBcolorvariationAmask, uv_FlakesRGBcolorvariationAmask );
				float4 lerpResult227 = lerp( lerpResult277 , tex2DNode228 , _FlakeColorVariationAmount);
				float FlakeMask284 = tex2DNode228.a;
				float4 lerpResult217 = lerp( lerpResult278 , lerpResult227 , FlakeMask284);
				...
				unpack7.z = lerp( 1, unpack7.z, saturate(_FlakesBump) );
				float3 Normal1335 = unpack7;
				float2 uv_CoatNormal = packedInput.ase_texcoord2.xy * _CoatNormal_ST.xy + _CoatNormal_ST.zw;
				float3 unpack171 = UnpackNormalScale( tex2D( _CoatNormal, uv_CoatNormal ), _CoatBump );
				unpack171.z = lerp( 1, unpack171.z, saturate(_CoatBump) );
				float3 Normal2340 = unpack171;
				float3 lerpResult208 = lerp( Normal1335 , Normal2340 , Blend331);
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_FlakesRGBcolorvariationAmask = packedInput.ase_texcoord3.xy * _FlakesRGBcolorvariationAmask_ST.xy + _FlakesRGBcolorvariationAmask_ST.zw;
				float3 unpack7 = UnpackNormalScale( tex2D( _FlakesNormal, uv_FlakesRGBcolorvariationAmask ), _FlakesBump );
				unpack7.z = lerp( 1, unpack7.z, saturate(_FlakesBump) );
				float3 Normal1335 = unpack7;
		...
		Pass
		{
				...
				)
			{
				...
				float fresnelNdotV279 = dot( ase_worldNormal, V );
				float fresnelNode279 = ( 0.05 + 1.0 * pow( 1.0 - fresnelNdotV279, 5.0 ) );
				float lerpResult306 = lerp( packedInput.ase_color.r , 1.0 , _BaseOcclusion);
				float Blend331 = ( ( fresnelNode279 * _CoatAmount ) * lerpResult306 );
				float3 lerpResult208 = lerp( Normal1335 , Normal2340 , Blend331);
		...
		Pass
		{
						...
						)
			{
				...
				float4 lerpResult278 = lerp( _BaseColor1 , _BaseColor2 , fresnelNode201);
				float4 lerpResult277 = lerp( _FlakesColor1 , _FlakesColor2 , fresnelNode201);
				float2 uv_FlakesRGBcolorvariationAmask = packedInput.ase_texcoord7.xy * _FlakesRGBcolorvariationAmask_ST.xy + _FlakesRGBcolorvariationAmask_ST.zw;
				float4 tex2DNode228 = tex2D( _FlakesRGBcolorvariationAmask, uv_FlakesRGBcolorvariationAmask );
				float4 lerpResult227 = lerp( lerpResult277 , tex2DNode228 , _FlakeColorVariationAmount);
				float FlakeMask284 = tex2DNode228.a;
				float4 lerpResult217 = lerp( lerpResult278 , lerpResult227 , FlakeMask284);
...
/*ASEBEGIN
Version=18920
303;172;1497;869;-1605.074;-692.6119;1;True;False
...
WireConnection;320;0;345;0
WireConnection;320;1;208;0
WireConnection;320;7;358;0
ASEEND*/
//CHKSM=17CC336F71A87023458D5747DB16E5696AAC5241