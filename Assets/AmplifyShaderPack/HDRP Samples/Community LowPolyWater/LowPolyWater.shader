...
Shader "AmplifyShaderPack/HDRP/Low Poly Water"
{
	Properties
	{
		...
		[ASEEnd]_NormalOnlyNoPolyMode("Normal (Only No Poly Mode)", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			#endif
			CBUFFER_END
			TEXTURE2D(_WaveGuide);
			SAMPLER(sampler_WaveGuide);
			TEXTURE2D(_NormalOnlyNoPolyMode);
			SAMPLER(sampler_NormalOnlyNoPolyMode);
			TEXTURE2D(_Foam);
			SAMPLER(sampler_Foam);
			TEXTURE2D(_FoamDistortion);
			SAMPLER(sampler_FoamDistortion);
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 VertexAnimation127 = ( ( SAMPLE_TEXTURE2D_LOD( _WaveGuide, sampler_WaveGuide, texCoord96, 1.0 ).r - 0.5 ) * ( inputMesh.normalOS * _WaveHeight ) );
						...
						)
			{
				...
				float3 Normal124 = (( _LowPoly )?( normalizeResult123 ):( UnpackNormalScale( SAMPLE_TEXTURE2D( _NormalOnlyNoPolyMode, sampler_NormalOnlyNoPolyMode, uv_NormalOnlyNoPolyMode ), 1.0f ) ));
				...
				float clampResult181 = clamp( SAMPLE_TEXTURE2D( _FoamDistortion, sampler_FoamDistortion, rotator182 ).r , 0.0 , 1.0 );
				float4 screenPos = packedInput.ase_texcoord6;
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float screenDepth164 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				...
				float4 lerpResult157 = lerp( ( _FoamColor * SAMPLE_TEXTURE2D( _Foam, sampler_Foam, rotator182 ) ) , float4(0,0,0,0) , clampResult191);
				float4 Emission162 = lerpResult157;
				float3 hdEmission225 = ASEGetEmissionHDRColor(Emission162.rgb,_EmissionIntensity,_EmissionWeight,GetInverseCurrentExposureMultiplier());
				
				surfaceDescription.Albedo = Albedo131.rgb;
				...
				surfaceDescription.Emission = hdEmission225;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv_NormalOnlyNoPolyMode = packedInput.ase_texcoord.xy * _NormalOnlyNoPolyMode_ST.xy + _NormalOnlyNoPolyMode_ST.zw;
				float3 ase_worldPos = packedInput.ase_texcoord1.xyz;
				float3 normalizeResult123 = normalize( ( cross( ddx( ase_worldPos ) , ddy( ase_worldPos ) ) + float3( 1E-09,0,0 ) ) );
				float3 Normal124 = (( _LowPoly )?( normalizeResult123 ):( UnpackNormalScale( SAMPLE_TEXTURE2D( _NormalOnlyNoPolyMode, sampler_NormalOnlyNoPolyMode, uv_NormalOnlyNoPolyMode ), 1.0f ) ));
				
				float4 speed183 = ( _Time * _WaveSpeed );
				float2 uv_Foam = packedInput.ase_texcoord.xy * _Foam_ST.xy + _Foam_ST.zw;
				float2 panner177 = ( speed183.x * float2( 0.5,0.5 ) + uv_Foam);
				float cos182 = cos( speed183.x );
				float sin182 = sin( speed183.x );
				float2 rotator182 = mul( panner177 - float2( 0,0 ) , float2x2( cos182 , -sin182 , sin182 , cos182 )) + float2( 0,0 );
...
/*ASEBEGIN
Version=18920
303;172;1497;869;2349.602;1080.727;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;15;-2777.374,-677.473;Float;False;Property;_WaveSpeed;Wave Speed;2;0;Create;True;0;0;0;False;0;False;0;0.72;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;167;-2382.478,814.4856;Float;False;Property;_FoamDist;Foam Dist;7;0;Create;True;0;0;0;False;0;False;0.1;0.158;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;43;-1398.183,-124.2504;Float;False;Property;_WaveHeight;Wave Height;3;0;Create;True;0;0;0;False;0;False;0;1.71;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;202;-1509.38,-870.8318;Inherit;True;Property;_NormalOnlyNoPolyMode;Normal (Only No Poly Mode);12;0;Create;True;0;0;0;False;0;False;-1;None;e9f5cbcd3734429daf37d699424eb645;True;0;True;white;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;2;-2759.492,-1253.385;Float;False;Property;_WaterColor;Water Color;0;0;Create;True;0;0;0;False;0;False;0.4926471,0.8740366,1,1;0.04313713,0.4470588,1,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ToggleSwitchNode;200;-1084.856,-668.6083;Float;False;Property;_LowPoly;Low Poly;11;0;Create;True;0;0;0;False;0;False;1;True;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;224;-775.4578,452.6884;Inherit;False;Property;_EmissionIntensity;Emission Intensity;8;0;Create;True;0;0;0;False;0;False;0;1.09;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;223;-768.6609,544.871;Inherit;False;Property;_EmissionWeight;Emission Weight;10;0;Create;True;0;0;0;False;0;False;0;1.12;0;0;0;1;FLOAT;0
...
WireConnection;225;0;163;0
WireConnection;225;1;224;0
WireConnection;225;2;223;0
WireConnection;211;0;134;0
WireConnection;211;1;125;0
WireConnection;211;6;225;0
WireConnection;211;9;11;0
WireConnection;211;11;128;0
ASEEND*/
//CHKSM=E2216DC27C58782A88518FADCE2153F697A54B22