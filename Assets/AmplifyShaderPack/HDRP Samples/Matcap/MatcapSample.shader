...
Shader "AmplifyShaderPack/HDRP/Matcap"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				surfaceDescription.Color = tex2D( _Matcap, ( ( mul( UNITY_MATRIX_V, float4( ase_worldNormal , 0.0 ) ).xyz * 0.5 ) + 0.5 ).xy ).rgb;
...
ASEEND*/
//CHKSM=FF5C4598B2D38CD61F9661F9D3A0BC28D52F007D