...
Shader "AmplifyShaderPack/HDRP/RimLight"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float3 tex2DNode3 = UnpackNormalScale( SAMPLE_TEXTURE2D( _Normals, sampler_Normals, uv_Normals ), 1.0f );
				...
				surfaceDescription.Metallic = SAMPLE_TEXTURE2D( _Metallic, sampler_Metallic, uv_Metallic ).r;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = 0;
				#endif

				surfaceDescription.Emission = ( pow( ( 1.0 - saturate( dotResult21 ) ) , _RimPower ) * _RimColor ).rgb;
...
/*ASEBEGIN
Version=18920
303;172;1497;869;530.298;-35.75818;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;28;-890.0026,467.6995;Float;False;Property;_RimPower;RimPower;1;0;Create;True;0;0;0;False;0;False;0;2.88;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;26;-600.6031,375.6995;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;25;-606.8026,555.4988;Float;False;Property;_RimColor;RimColor;0;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,1,0.8916161,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=31BD14FA0311AB39B457B44C093894A0ED88B1C6