...
Shader "AmplifyShaderPack/HDRP/SimpleRefraction"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float2 uv_RefractionMap = packedInput.ase_texcoord2.xy * _RefractionMap_ST.xy + _RefractionMap_ST.zw;
				float4 fetchOpaqueVal8 = ASEHDSampleSceneColor(( (ase_grabScreenPosNorm).xy + (( UnpackNormalScale( tex2D( _RefractionMap, uv_RefractionMap ), 1.0f ) * _Distortion )).xy ), 0.0, GetInverseCurrentExposureMultiplier());
...
/*ASEBEGIN
Version=18920
303;172;1497;869;1763.685;272.1469;1.3;True;False
...
ASEEND*/
//CHKSM=C9E5AF4FED12B1ACE15342D71D3F597F8820FE2D