...
Shader "AmplifyShaderPack/HDRP/Smear"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 worldToObj117 = mul( GetWorldToObjectMatrix(), float4( GetCameraRelativePositionWS(finalVertexWorldPosition80), 1 ) ).xyz;
				...
				#endif
				float3 vertexValue = worldToObj117;
						...
						)
			{
				...
				surfaceDescription.Albedo = ( tex2D( _Albedo, uv_Albedo ) * _Tint ).rgb;
...
/*ASEBEGIN
Version=18920
-2553;274;2560;1111;-1568.41;-214.678;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;58;590.5559,120.4073;Float;False;Property;_NoiseHeightScale;Noise Height Scale;6;0;Create;True;0;0;0;False;0;False;0;0.57;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;55;962.3575,169.0076;Float;False;Property;_NoiseInfluence;Noise Influence;5;0;Create;True;0;0;0;False;0;False;0.5;0.26;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;65;1722.855,498.3999;Inherit;False;1166.783;452.0805;Add the bulge to the final position and convert the result to object space;5;80;39;40;48;117;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.TransformPositionNode;117;2571.41,712.678;Inherit;False;World;Object;False;Fast;True;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;71;2571.201,260.3512;Float;False;Property;_Smoothness;Smoothness;3;0;Create;True;0;0;0;False;0;False;0;0.67;0;1;0;1;FLOAT;0
...
WireConnection;106;4;70;0
WireConnection;106;7;71;0
WireConnection;106;11;117;0
ASEEND*/
//CHKSM=5FBA6877CA6A07B71AA6394DAFB70F31072C0EBE