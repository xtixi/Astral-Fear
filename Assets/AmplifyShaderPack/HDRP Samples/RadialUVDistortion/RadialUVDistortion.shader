...
Shader "AmplifyShaderPack/HDRP/RadialUVDistortion"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_NoiseMap1("Noise Map", 2D) = "white" {}
		_NoiseMapStrength1("NoiseMapStrength", Range( 0 , 1)) = 0
		_RingPannerSpeed1("RingPannerSpeed", Vector) = (0,0,0,0)
		_NoiseMapSize1("NoiseMapSize", Vector) = (512,512,0,0)
		_NoiseMapPannerSpeed1("NoiseMapPannerSpeed", Vector) = (0,0,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _Tint1;
			float2 _NoiseMapSize1;
			float2 _NoiseMapPannerSpeed1;
			float2 _RingPannerSpeed1;
			float _NoiseMapStrength1;
			...
			UNITY_DOTS_INSTANCING_START(MaterialPropertyMetadata)
				UNITY_DOTS_INSTANCED_PROP(float4, _Tint1)
			UNITY_DOTS_INSTANCING_END(MaterialPropertyMetadata)
			#define _Tint1 UNITY_ACCESS_DOTS_INSTANCED_PROP_FROM_MACRO(float4 , Metadata__Tint1)
			#endif
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 temp_output_1_0_g33 = _NoiseMapSize1;
				...
				float2 temp_output_11_0_g33 = _NoiseMapPannerSpeed1;
				...
				float2 temp_output_47_0_g33 = _RingPannerSpeed1;
				...
				float4 tex2DNode18 = tex2Dlod( _BaseTexture1, float4( ( ( (tex2Dlod( _NoiseMap1, float4( ( appendResult10_g33 + appendResult24_g33 ), 0, 0.0) )).rg * _NoiseMapStrength1 ) + ( float2( 1,1 ) * appendResult58_g33 ) ), 0, 0.0) );
				...
				#endif
				float3 vertexValue = ( ( tex2DNode18 * float4( inputMesh.normalOS , 0.0 ) ) * _OffsetMultiplier ).rgb;
						...
						)
			{
				...
				float2 panner55_g33 = ( ( _TimeParameters.x * (temp_output_47_0_g33).y ) * float2( 0,1 ) + appendResult39_g33);
				float2 appendResult58_g33 = (float2((panner54_g33).x , (panner55_g33).y));
				float4 tex2DNode18 = tex2D( _BaseTexture1, ( ( (tex2D( _NoiseMap1, ( appendResult10_g33 + appendResult24_g33 ) )).rg * _NoiseMapStrength1 ) + ( float2( 1,1 ) * appendResult58_g33 ) ) );
				float3 hdEmission23 = ASEGetEmissionHDRColor(( _Tint1 * tex2DNode18 ).rgb,_EmissionIntensity1,_EmissionWeight1,GetInverseCurrentExposureMultiplier());
				
				surfaceDescription.Albedo = color24.rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 temp_output_1_0_g33 = _NoiseMapSize1;
				float2 texCoord80_g33 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult10_g33 = (float2(( (temp_output_1_0_g33).x * texCoord80_g33.x ) , ( texCoord80_g33.y * (temp_output_1_0_g33).y )));
				float2 temp_output_11_0_g33 = _NoiseMapPannerSpeed1;
				float2 texCoord81_g33 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner18_g33 = ( ( (temp_output_11_0_g33).x * _TimeParameters.x ) * float2( 1,0 ) + texCoord81_g33);
				float2 panner19_g33 = ( ( _TimeParameters.x * (temp_output_11_0_g33).y ) * float2( 0,1 ) + texCoord81_g33);
				float2 appendResult24_g33 = (float2((panner18_g33).x , (panner19_g33).y));
				float2 temp_output_47_0_g33 = _RingPannerSpeed1;
				float2 texCoord78_g33 = packedInput.ase_texcoord.xy * float2( 2,2 ) + float2( 0,0 );
				float2 temp_output_31_0_g33 = ( texCoord78_g33 - float2( 1,1 ) );
				float2 appendResult39_g33 = (float2(frac( ( atan2( (temp_output_31_0_g33).x , (temp_output_31_0_g33).y ) / TWO_PI ) ) , length( temp_output_31_0_g33 )));
				float2 panner54_g33 = ( ( (temp_output_47_0_g33).x * _TimeParameters.x ) * float2( 1,0 ) + appendResult39_g33);
				float2 panner55_g33 = ( ( _TimeParameters.x * (temp_output_47_0_g33).y ) * float2( 0,1 ) + appendResult39_g33);
...
/*ASEBEGIN
Version=18920
303;172;1497;869;1015.576;499.1199;1;True;False
Node;AmplifyShaderEditor.Vector2Node;16;-1817.749,-83.75332;Float;False;Property;_NoiseMapSize1;NoiseMapSize;3;0;Create;True;0;0;0;False;0;False;512,512;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.TexturePropertyNode;15;-1828.986,-277.2007;Float;True;Property;_NoiseMap1;Noise Map;0;0;Create;True;0;0;0;False;0;False;None;937c2d88ef9b4e889d5a0a6a952c1a4b;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.Vector2Node;14;-1806.688,278.3668;Float;False;Constant;_Vector1;Vector 0;7;0;Create;True;0;0;0;False;0;False;1,1;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;13;-1835.574,431.9887;Float;False;Property;_RingPannerSpeed1;RingPannerSpeed;2;0;Create;True;0;0;0;False;0;False;0,0;0.1,-1.27;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;12;-1859.115,45.55312;Float;False;Property;_NoiseMapPannerSpeed1;NoiseMapPannerSpeed;4;0;Create;True;0;0;0;False;0;False;0,0;1.61,-0.43;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;11;-1848.787,167.0771;Float;False;Property;_NoiseMapStrength1;NoiseMapStrength;1;0;Create;True;0;0;0;False;0;False;0;0.393;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;19;-907.5871,-202.0305;Float;False;Property;_Tint1;Tint;6;0;Create;True;0;0;0;False;0;True;0,0,0,0;1,0.2214085,0.03301889,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;18;-868.8989,50.70961;Inherit;True;Property;_BaseTexture1;Base Texture;5;0;Create;True;0;0;0;False;0;False;-1;None;468c5859e2a9496ea1afdbc5cfce02ee;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;22;-402.198,214.3099;Inherit;False;Property;_EmissionIntensity1;Emission Intensity;7;0;Create;True;0;0;0;False;0;False;0;5.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;21;-394.4979,297.7099;Inherit;False;Property;_EmissionWeight1;Emission Weight;8;0;Create;True;0;0;0;False;0;False;0;3.93;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.HDEmissionNode;23;-166.0992,92.07797;Inherit;False;Luminance;False;3;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.ColorNode;24;-197.613,-145.8714;Inherit;False;Constant;_Color0;Color 0;9;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=28050B39D6DC2142EA5457C5D6FE86E7DA808359