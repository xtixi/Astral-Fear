...
Shader "AmplifyShaderPack/HDRP/ScreenSpaceDetail"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			TEXTURE2D(_ScreenDetail);
			SAMPLER(sampler_ScreenDetail);
						...
						)
			{
				...
				float4 tex2DNode2 = SAMPLE_TEXTURE2D( _ScreenDetail, sampler_ScreenDetail, ( (ase_screenPosNorm).xy * float2( 8,8 ) ) );
				
				surfaceDescription.Albedo = ( SAMPLE_TEXTURE2D( _Albedo, sampler_Albedo, uv_Albedo ) * tex2DNode2 ).rgb;
				...
				surfaceDescription.Emission = tex2DNode2.rgb;
...
/*ASEBEGIN
Version=18920
303;172;1497;869;1422.629;286.1304;1;True;False
...
Node;AmplifyShaderEditor.SamplerNode;2;-544,128;Inherit;True;Property;_ScreenDetail;ScreenDetail;0;0;Create;True;0;0;0;False;0;False;-1;None;aab8de1052c54173b3d61e7f8b05aedf;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;11;6;2;0
ASEEND*/
//CHKSM=C5510B88BB3A899C51DCF701263FF1C114D4FB5C