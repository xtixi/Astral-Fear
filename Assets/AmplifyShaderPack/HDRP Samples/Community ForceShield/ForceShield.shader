...
Shader "AmplifyShaderPack/HDRP/Force Shield"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			TEXTURE2D(_ShieldPattern);
			SAMPLER(sampler_ShieldPattern);
			TEXTURE2D(_ShieldPatternWaves);
			SAMPLER(sampler_ShieldPatternWaves);
						...
						)
			{
				...
				float4 Albedo279 = ( _Color * SAMPLE_TEXTURE2D( _Albedo, sampler_Albedo, uv_Albedo ) );
				
				float2 uv_Normal = packedInput.ase_texcoord5.xy * _Normal_ST.xy + _Normal_ST.zw;
				float3 Normal282 = UnpackNormalScale( SAMPLE_TEXTURE2D( _Normal, sampler_Normal, uv_Normal ), 1.0f );
				...
				float4 ShieldPattern17 = SAMPLE_TEXTURE2D( _ShieldPattern, sampler_ShieldPattern, texCoord41 );
				...
				float4 waves94 = SAMPLE_TEXTURE2D( _ShieldPatternWaves, sampler_ShieldPatternWaves, texCoord87 );
				...
				float screenDepth110 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				...
				float3 hdEmission304 = ASEGetEmissionHDRColor(Emission120.rgb,_EmissionIntensity,_EmissionWeight,GetInverseCurrentExposureMultiplier());
				
				surfaceDescription.Albedo = Albedo279.rgb;
				...
				surfaceDescription.Emission = hdEmission304;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 ShieldSpeed84 = ( _Time * _ShieldAnimSpeed );
				float2 appendResult46 = (float2(1 , ShieldSpeed84.x));
				float2 texCoord41 = packedInput.ase_texcoord.xy * appendResult130 + appendResult46;
				float4 ShieldPattern17 = SAMPLE_TEXTURE2D( _ShieldPattern, sampler_ShieldPattern, texCoord41 );
				float2 appendResult91 = (float2(1 , ( 1.0 - ( ShieldSpeed84 / 5.0 ) ).x));
				float2 texCoord87 = packedInput.ase_texcoord.xy * float2( 1,1 ) + appendResult91;
				float4 waves94 = SAMPLE_TEXTURE2D( _ShieldPatternWaves, sampler_ShieldPatternWaves, texCoord87 );
				float temp_output_152_0 = distance( packedInput.ase_texcoord3.xyz , _HitPosition );
				float HitSize141 = _HitSize;
				float4 ShieldPatternColor12 = _ShieldPatternColor;
				float4 HitColor139 = _HitColor;
				float4 lerpResult245 = lerp( ShieldPatternColor12 , ( HitColor139 * ( HitSize141 / temp_output_152_0 ) ) , (0.0 + (_HitTime - 0.0) * (1.0 - 0.0) / (100.0 - 0.0)));
...
/*ASEBEGIN
Version=18920
303;172;1497;869;1584.673;1807.171;1;True;False
...
Node;AmplifyShaderEditor.ColorNode;3;-2716.901,-1757.5;Float;False;Property;_ShieldPatternColor;Shield Pattern Color;4;0;Create;True;0;0;0;False;0;False;0.2470588,0.7764706,0.9098039,1;0.6792453,0.4572605,0.3043787,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;114;-3430.724,1320.123;Float;False;Property;_IntersectIntensity;Intersect Intensity;14;0;Create;True;0;0;0;False;0;False;0.2;0.6199046;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;122;-2961.037,841.2547;Float;False;Property;_IntersectColor;Intersect Color;15;0;Create;True;0;0;0;False;0;False;0.03137255,0.2588235,0.3176471,1;0.9622641,0.2196139,0,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;102;-1432.937,42.85229;Float;False;Property;_ShieldDistortion;Shield Distortion;13;0;Create;True;0;0;0;False;0;False;0.01;0.0083;0;0.03;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;302;-1198.996,-1282.771;Inherit;False;Property;_EmissionIntensity;Emission Intensity;8;0;Create;True;0;0;0;False;0;False;0;7.32;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;121;-1083.618,-1460.73;Inherit;False;120;Emission;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;303;-1195.933,-1198.578;Inherit;False;Property;_EmissionWeight;Emission Weight;9;0;Create;True;0;0;0;False;0;False;0;2.86;0;0;0;1;FLOAT;0
...
WireConnection;304;0;121;0
WireConnection;304;1;302;0
WireConnection;304;2;303;0
WireConnection;290;0;280;0
WireConnection;290;1;283;0
WireConnection;290;6;304;0
WireConnection;290;9;28;0
WireConnection;290;11;272;0
ASEEND*/
//CHKSM=26A65B7B77EB9FD97C1B652974C95F34FD162BFA