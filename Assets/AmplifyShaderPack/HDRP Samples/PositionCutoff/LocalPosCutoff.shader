...
Shader "AmplifyShaderPack/HDRP/LocalPosCutoff"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float temp_output_15_0 = saturate( ( ( (( _UseObjectSpace )?( packedInput.ase_texcoord6.xyz.y ):( ase_worldPos.y )) + _StartPoint ) / _Distribution ) );
				float clampResult30 = clamp( temp_output_15_0 , _UnderwaterInfluence , 1.0 );
				float4 lerpResult52 = lerp( _Tint , SAMPLE_TEXTURE2D( _Albedo, sampler_Albedo, uv_Albedo ) , clampResult30);
				...
				float4 temp_output_49_0 = ( SAMPLE_TEXTURE2D( _Metallic, sampler_Metallic, uv_Metallic ) + ( 1.0 - temp_output_15_0 ) );
				
				float2 uv_Occlusion = packedInput.ase_texcoord5.xy * _Occlusion_ST.xy + _Occlusion_ST.zw;
				
				surfaceDescription.Albedo = lerpResult52.rgb;
				surfaceDescription.Normal = UnpackNormalScale( SAMPLE_TEXTURE2D( _Normals, sampler_Normals, uv_Normals ), 1.0f );
				...
				surfaceDescription.Occlusion = SAMPLE_TEXTURE2D( _Occlusion, sampler_Occlusion, uv_Occlusion ).r;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float temp_output_15_0 = saturate( ( ( (( _UseObjectSpace )?( packedInput.ase_texcoord2.xyz.y ):( ase_worldPos.y )) + _StartPoint ) / _Distribution ) );
				float clampResult30 = clamp( temp_output_15_0 , _UnderwaterInfluence , 1.0 );
				float4 lerpResult52 = lerp( _Tint , SAMPLE_TEXTURE2D( _Albedo, sampler_Albedo, uv_Albedo ) , clampResult30);
		...
		Pass
		{
					...
					)
			{
				...
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float temp_output_15_0 = saturate( ( ( (( _UseObjectSpace )?( packedInput.ase_texcoord4.xyz.y ):( ase_worldPos.y )) + _StartPoint ) / _Distribution ) );
				float4 temp_output_49_0 = ( SAMPLE_TEXTURE2D( _Metallic, sampler_Metallic, uv_Metallic ) + ( 1.0 - temp_output_15_0 ) );
		...
		Pass
		{
				...
				)
			{
				...
				float temp_output_15_0 = saturate( ( ( (( _UseObjectSpace )?( packedInput.ase_texcoord5.xyz.y ):( ase_worldPos.y )) + _StartPoint ) / _Distribution ) );
				float4 temp_output_49_0 = ( SAMPLE_TEXTURE2D( _Metallic, sampler_Metallic, uv_Metallic ) + ( 1.0 - temp_output_15_0 ) );
		...
		Pass
		{
						...
						)
			{
				...
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float temp_output_15_0 = saturate( ( ( (( _UseObjectSpace )?( packedInput.ase_texcoord8.xyz.y ):( ase_worldPos.y )) + _StartPoint ) / _Distribution ) );
				float clampResult30 = clamp( temp_output_15_0 , _UnderwaterInfluence , 1.0 );
				float4 lerpResult52 = lerp( _Tint , SAMPLE_TEXTURE2D( _Albedo, sampler_Albedo, uv_Albedo ) , clampResult30);
...
/*ASEBEGIN
Version=18920
303;172;1497;869;2056.324;-321.9207;1.3;True;False
...
Node;AmplifyShaderEditor.ToggleSwitchNode;76;-1034.569,657.2612;Inherit;False;Property;_UseObjectSpace;Use Object Space;0;0;Create;True;0;0;0;False;0;False;0;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;54;-797.8809,691.9092;Float;False;Property;_UnderwaterInfluence;UnderwaterInfluence;4;0;Create;True;0;0;0;False;0;False;0;0.397;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;34;-108.9506,481.5498;Float;False;Property;_SmoothnessFactor;SmoothnessFactor;2;0;Create;True;0;0;0;False;0;False;0;0.672;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;53;-512,-32;Float;False;Property;_Tint;Tint;5;0;Create;True;0;0;0;False;0;False;0.5294118,0.4264289,0,0;0.735849,0.1797564,0.1006586,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;65;8;20;0
ASEEND*/
//CHKSM=CBD4BB97B531A58C82DE5D5F8E4303FAE3D7C94E