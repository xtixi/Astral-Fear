...
Shader "AmplifyShaderPack/HDRP/LocalGradient"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 lerpResult3 = lerp( _Bottom , _Top , saturate( packedInput.ase_texcoord5.xyz.z ));
				
				surfaceDescription.Albedo = lerpResult3.rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float4 lerpResult3 = lerp( _Bottom , _Top , saturate( packedInput.ase_texcoord.xyz.z ));
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float4 lerpResult3 = lerp( _Bottom , _Top , saturate( packedInput.ase_texcoord7.xyz.z ));
...
Node;AmplifyShaderEditor.ColorNode;4;-542.8,-201.1001;Float;False;Property;_Bottom;Bottom;1;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.2352939,0.2061327,0.1903112,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=CCD0DE38248596BA8ADFC6E4E6C83C07DCB08028