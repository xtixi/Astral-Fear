...
Shader "AmplifyShaderPack/HDRP/LetItFlow"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord26 = packedInput.ase_texcoord6.xy * temp_cast_1 + float2( 0,0 );
				float2 temp_output_4_0_g20 = (( texCoord26 / _Size )).xy;
				float2 uv_FlowMap = packedInput.ase_texcoord6.xy * _FlowMap_ST.xy + _FlowMap_ST.zw;
				float2 temp_output_17_0_g20 = _FlowStrength;
				float mulTime22_g20 = _TimeParameters.x * _FlowSpeed;
				float temp_output_27_0_g20 = frac( mulTime22_g20 );
				float2 temp_output_11_0_g20 = ( temp_output_4_0_g20 + ( -((tex2D( _FlowMap, uv_FlowMap )).rg*2.0 + -1.0) * temp_output_17_0_g20 * temp_output_27_0_g20 ) );
				float temp_output_55_0_g20 = _NormalScale;
				float3 unpack48_g20 = UnpackNormalScale( tex2D( _Normal, temp_output_11_0_g20 ), temp_output_55_0_g20 );
				unpack48_g20.z = lerp( 1, unpack48_g20.z, saturate(temp_output_55_0_g20) );
				float2 temp_output_12_0_g20 = ( temp_output_4_0_g20 + ( -((tex2D( _FlowMap, uv_FlowMap )).rg*2.0 + -1.0) * temp_output_17_0_g20 * frac( ( mulTime22_g20 + 0.5 ) ) ) );
				float3 unpack49_g20 = UnpackNormalScale( tex2D( _Normal, temp_output_12_0_g20 ), temp_output_55_0_g20 );
				unpack49_g20.z = lerp( 1, unpack49_g20.z, saturate(temp_output_55_0_g20) );
				float3 lerpResult9_g20 = lerp( unpack48_g20 , unpack49_g20 , ( abs( ( temp_output_27_0_g20 - 0.5 ) ) / 0.5 ));
				float4 fetchOpaqueVal49 = ASEHDSampleSceneColor(( float3( (ase_grabScreenPosNorm).xy ,  0.0 ) + ( lerpResult9_g20 * _NormalStrength ) ).xy, 0.0, GetInverseCurrentExposureMultiplier());
				
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float screenDepth59 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth59 = saturate( ( screenDepth59 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _FadeDistance ) );
				
				surfaceDescription.Albedo = ( _RiverColor * fetchOpaqueVal49 ).rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 ase_grabScreenPosNorm = ase_grabScreenPos / ase_grabScreenPos.w;
				float2 temp_cast_1 = (_Tiling).xx;
				float2 texCoord26 = packedInput.ase_texcoord1.xy * temp_cast_1 + float2( 0,0 );
				float2 temp_output_4_0_g20 = (( texCoord26 / _Size )).xy;
		...
		Pass
		{
						...
						)
			{
				...
				float4 ase_grabScreenPosNorm = ase_grabScreenPos / ase_grabScreenPos.w;
				float2 temp_cast_1 = (_Tiling).xx;
				float2 texCoord26 = packedInput.ase_texcoord8.xy * temp_cast_1 + float2( 0,0 );
				float2 temp_output_4_0_g20 = (( texCoord26 / _Size )).xy;
				float2 uv_FlowMap = packedInput.ase_texcoord8.xy * _FlowMap_ST.xy + _FlowMap_ST.zw;
				float2 temp_output_17_0_g20 = _FlowStrength;
				float mulTime22_g20 = _TimeParameters.x * _FlowSpeed;
				float temp_output_27_0_g20 = frac( mulTime22_g20 );
				float2 temp_output_11_0_g20 = ( temp_output_4_0_g20 + ( -((tex2D( _FlowMap, uv_FlowMap )).rg*2.0 + -1.0) * temp_output_17_0_g20 * temp_output_27_0_g20 ) );
...
/*ASEBEGIN
Version=18920
303;172;1497;869;1611.064;178.6141;1.6;True;False
Node;AmplifyShaderEditor.SamplerNode;7;-1031.8,484.4438;Inherit;True;Property;_FlowMap;Flow Map;3;0;Create;True;0;0;0;False;0;False;-1;None;857a3925d05e5ff4f82825804691c22e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;27;-1032,289.5999;Inherit;False;Property;_Tiling;Tiling;9;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;3;-1016,81.6;Inherit;True;Property;_Normal;Normal;6;0;Create;True;0;0;0;False;0;False;None;3870bf0e58484ded877fb5a340656651;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.SwizzleNode;8;-736.9997,492.2436;Inherit;False;FLOAT2;0;1;2;3;1;0;COLOR;0,0,0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;22;-1033.14,822.9459;Inherit;False;Property;_FlowSpeed;Flow Speed;4;0;Create;True;0;0;0;False;0;False;0;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;26;-823.9998,289.5999;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;25;-1026.722,690.8553;Inherit;False;Property;_FlowStrength;Flow Strength;5;0;Create;True;0;0;0;False;0;False;0,0;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;42;-1032,401.5999;Inherit;False;Property;_NormalScale;Normal Scale;7;0;Create;True;0;0;0;False;0;False;0;1;1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;72;-403.9769,350.5726;Inherit;False;Flow;0;;20;acad10cc8145e1f4eb8042bebe2d9a42;2,50,1,51,1;6;5;SAMPLER2D;;False;2;FLOAT2;0,0;False;55;FLOAT;1;False;18;FLOAT2;0,0;False;17;FLOAT2;1,1;False;24;FLOAT;0.2;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;55;-87.175,477.53;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
WireConnection;61;7;57;0
WireConnection;61;9;59;0
ASEEND*/
//CHKSM=CCA2861B194E07D9F3B0A1B1236553001CF3FEE7