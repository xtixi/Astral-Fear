...
Shader "AmplifyShaderPack/HDRP/Totem"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = tex2D( _Specular, uv_Specular ).rgb;
				#endif
...
/*ASEBEGIN
Version=18920
303;172;1497;869;905.5;-7.5;1;True;False
