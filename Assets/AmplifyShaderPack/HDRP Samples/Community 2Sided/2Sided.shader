...
Shader "AmplifyShaderPack/HDRP/2 Sided"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 FrontFacesAlbedo44 = ( _FrontFacesColor * SAMPLE_TEXTURE2D( _FrontFacesAlbedo, sampler_FrontFacesAlbedo, uv_FrontFacesAlbedo ) );
				float2 uv_BackFacesAlbedo = packedInput.ase_texcoord5.xy * _BackFacesAlbedo_ST.xy + _BackFacesAlbedo_ST.zw;
				float4 BackFacesAlbedo47 = ( _BackFacesColor * SAMPLE_TEXTURE2D( _BackFacesAlbedo, sampler_BackFacesAlbedo, uv_BackFacesAlbedo ) );
				...
				float3 FrontFacesNormal51 = UnpackNormalScale( SAMPLE_TEXTURE2D( _FrontFacesNormal, sampler_FrontFacesNormal, uv_FrontFacesNormal ), 1.0f );
				float2 uv_BackFacesNormal = packedInput.ase_texcoord5.xy * _BackFacesNormal_ST.xy + _BackFacesNormal_ST.zw;
				float3 BackFacesNormal54 = UnpackNormalScale( SAMPLE_TEXTURE2D( _BackFacesNormal, sampler_BackFacesNormal, uv_BackFacesNormal ), 1.0f );
				...
				float OpacityMask56 = SAMPLE_TEXTURE2D( _OpacityMask, sampler_OpacityMask, uv_OpacityMask ).a;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_FrontFacesAlbedo = packedInput.ase_texcoord.xy * _FrontFacesAlbedo_ST.xy + _FrontFacesAlbedo_ST.zw;
				float4 FrontFacesAlbedo44 = ( _FrontFacesColor * SAMPLE_TEXTURE2D( _FrontFacesAlbedo, sampler_FrontFacesAlbedo, uv_FrontFacesAlbedo ) );
				float2 uv_BackFacesAlbedo = packedInput.ase_texcoord.xy * _BackFacesAlbedo_ST.xy + _BackFacesAlbedo_ST.zw;
				float4 BackFacesAlbedo47 = ( _BackFacesColor * SAMPLE_TEXTURE2D( _BackFacesAlbedo, sampler_BackFacesAlbedo, uv_BackFacesAlbedo ) );
				...
				float2 uv_FrontFacesNormal = packedInput.ase_texcoord.xy * _FrontFacesNormal_ST.xy + _FrontFacesNormal_ST.zw;
				float3 FrontFacesNormal51 = UnpackNormalScale( SAMPLE_TEXTURE2D( _FrontFacesNormal, sampler_FrontFacesNormal, uv_FrontFacesNormal ), 1.0f );
				float2 uv_BackFacesNormal = packedInput.ase_texcoord.xy * _BackFacesNormal_ST.xy + _BackFacesNormal_ST.zw;
				float3 BackFacesNormal54 = UnpackNormalScale( SAMPLE_TEXTURE2D( _BackFacesNormal, sampler_BackFacesNormal, uv_BackFacesNormal ), 1.0f );
				float3 lerpResult64 = lerp( FrontFacesNormal51 , BackFacesNormal54 , FaceSign48);
				
				float2 uv_OpacityMask = packedInput.ase_texcoord.xy * _OpacityMask_ST.xy + _OpacityMask_ST.zw;
				float OpacityMask56 = SAMPLE_TEXTURE2D( _OpacityMask, sampler_OpacityMask, uv_OpacityMask ).a;
		...
		Pass
		{
				...
				)
			{
				...
				float dotResult20 = dot( ase_worldNormal , V );
				float FaceSign48 = (1.0 + (sign( dotResult20 ) - -1.0) * (0.0 - 1.0) / (1.0 - -1.0));
				float3 lerpResult64 = lerp( FrontFacesNormal51 , BackFacesNormal54 , FaceSign48);
...
/*ASEBEGIN
Version=18920
303;172;1497;869;1366.583;1051.321;1.781308;True;False
...
ASEEND*/
//CHKSM=E886A6C58CF23847EE806579A49E9BA02A0D5F62