...
Shader "AmplifyShaderPack/HDRP/Parallax/SandPom"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			inline float2 POM( TEXTURE2D(heightMap), SAMPLER(samplerheightMap), float2 uvs, float2 dx, float2 dy, float3 normalWorld, float3 viewWorld, float3 viewDirTan, int minSamples, int maxSamples, float parallax, float refPlane, float2 tilling, float2 curv, int index )
			{
				...
				while ( stepIndex < numSteps + 1 )
				{
				 	...
				 	currHeight = SAMPLE_TEXTURE2D_GRAD( heightMap, samplerheightMap, uvs + currTexOffset, dx, dy ).r * ( 1 - result.z );
						...
						)
			{
				...
				float2 OffsetPOM8 = POM( _HeightMap, sampler_HeightMap, uv_Albedo, ddx(uv_Albedo), ddy(uv_Albedo), normalWS, V, ase_tanViewDir, 128, 128, _Scale, 0, _HeightMap_ST.xy, appendResult47, 0 );
				float2 customUVs39 = OffsetPOM8;
				float2 temp_output_40_0 = ddx( uv_Albedo );
				float2 temp_output_41_0 = ddy( uv_Albedo );
				
				float3 unpack14 = UnpackNormalScale( SAMPLE_TEXTURE2D_GRAD( _Normal, sampler_Normal, customUVs39, temp_output_40_0, temp_output_41_0 ), _NormalScale );
				unpack14.z = lerp( 1, unpack14.z, saturate(_NormalScale) );
				
				surfaceDescription.Albedo = SAMPLE_TEXTURE2D_GRAD( _Albedo, sampler_Albedo, customUVs39, temp_output_40_0, temp_output_41_0 ).rgb;
				surfaceDescription.Normal = unpack14;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = SAMPLE_TEXTURE2D_GRAD( _Metallic, sampler_Metallic, customUVs39, temp_output_40_0, temp_output_41_0 ).r;
				...
				surfaceDescription.Smoothness = ( _RoughScale * SAMPLE_TEXTURE2D_GRAD( _Roughness, sampler_Roughness, customUVs39, temp_output_40_0, temp_output_41_0 ).r );
				surfaceDescription.Occlusion = SAMPLE_TEXTURE2D_GRAD( _Occlusion, sampler_Occlusion, customUVs39, temp_output_40_0, temp_output_41_0 ).r;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				ase_tanViewDir = normalize(ase_tanViewDir);
				float2 appendResult47 = (float2(_CurvatureU , _CurvatureV));
				float2 OffsetPOM8 = POM( _HeightMap, sampler_HeightMap, uv_Albedo, ddx(uv_Albedo), ddy(uv_Albedo), ase_worldNormal, ase_worldViewDir, ase_tanViewDir, 128, 128, _Scale, 0, _HeightMap_ST.xy, appendResult47, 0 );
				float2 customUVs39 = OffsetPOM8;
				float2 temp_output_40_0 = ddx( uv_Albedo );
				float2 temp_output_41_0 = ddy( uv_Albedo );
		...
		Pass
		{
				...
				)
			{
				...
				ase_tanViewDir = normalize(ase_tanViewDir);
				float2 appendResult47 = (float2(_CurvatureU , _CurvatureV));
				float2 OffsetPOM8 = POM( _HeightMap, sampler_HeightMap, uv_Albedo, ddx(uv_Albedo), ddy(uv_Albedo), ase_worldNormal, V, ase_tanViewDir, 128, 128, _Scale, 0, _HeightMap_ST.xy, appendResult47, 0 );
				float2 customUVs39 = OffsetPOM8;
				float2 temp_output_40_0 = ddx( uv_Albedo );
				float2 temp_output_41_0 = ddy( uv_Albedo );
				float3 unpack14 = UnpackNormalScale( SAMPLE_TEXTURE2D_GRAD( _Normal, sampler_Normal, customUVs39, temp_output_40_0, temp_output_41_0 ), _NormalScale );
...
/*ASEBEGIN
Version=18920
303;172;1497;869;958.358;409.2993;1.486851;True;False
...
Node;AmplifyShaderEditor.TexturePropertyNode;9;-1729,0.5;Float;True;Property;_HeightMap;HeightMap;7;0;Create;True;0;0;0;False;0;False;None;3e6336f4d7114961a7d3d4cc29181200;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.SamplerNode;20;64,336;Inherit;True;Property;_Roughness;Roughness;4;0;Create;True;0;0;0;False;0;False;-1;None;c7d62dd1f3674b85ba6502ab04da839d;True;0;False;white;Auto;False;Object;-1;Derivative;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;25;190.5132,254.5132;Float;False;Property;_RoughScale;Rough Scale;5;0;Create;True;0;0;0;False;0;False;0.5;0.8;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;11;64,-320;Inherit;True;Property;_Albedo;Albedo;0;0;Create;True;0;0;0;False;0;False;-1;None;07738f0e3d274495837c31040b762233;True;0;False;white;Auto;False;Object;-1;Derivative;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;53;4;23;1
WireConnection;53;7;26;0
WireConnection;53;8;29;0
ASEEND*/
//CHKSM=D8232285908131380DBA2EB9D12D8175A46DA2F5