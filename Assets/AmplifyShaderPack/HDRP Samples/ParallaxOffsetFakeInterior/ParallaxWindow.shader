...
Shader "AmplifyShaderPack/HDRP/ParallaxWindow"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 lerpResult48 = lerp( ( SAMPLE_TEXTURE2D( _Back, sampler_Back, OffsetBack70 ) * _BackDark ) , ( SAMPLE_TEXTURE2D( _Mid, sampler_Mid, OffsetMid15 ) * _MidDark ) , SAMPLE_TEXTURE2D( _Mask, sampler_Mask, OffsetMid15 ).g);
				float4 tex2DNode62 = SAMPLE_TEXTURE2D( _Mask, sampler_Mask, texCoord9 );
				float4 lerpResult58 = lerp( lerpResult48 , SAMPLE_TEXTURE2D( _Front, sampler_Front, texCoord9 ) , tex2DNode62.r);
...
/*ASEBEGIN
Version=18920
303;172;1497;869;301.005;-38.02193;1.564713;True;False
...
ASEEND*/
//CHKSM=EB521BD901C5752EA06BBCA2039AF1BFB0480032