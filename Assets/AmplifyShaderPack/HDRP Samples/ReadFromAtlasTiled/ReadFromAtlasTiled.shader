...
Shader "AmplifyShaderPack/HDRP/ReadFromAtlasTiled"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				surfaceDescription.Emission = SAMPLE_TEXTURE2D( _Atlas, sampler_Atlas, ( ScaledMin27 + ( TiledVar55 * _TileSize ) ) ).rgb;
...
/*ASEBEGIN
Version=18920
303;172;1497;869;260.5591;690.4482;1;True;False
...
WireConnection;58;6;30;0
ASEEND*/
//CHKSM=FEA20BAF1D1C407DC509D4A2B3A0AC3D0DA4E200