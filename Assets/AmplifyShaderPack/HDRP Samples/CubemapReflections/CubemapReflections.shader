...
Shader "AmplifyShaderPack/HDRP/CubemapReflections"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float3 tex2DNode10 = UnpackNormalScale( SAMPLE_TEXTURE2D( _Normals, sampler_Normals, uv_Normals ), 1.0f );
				...
				surfaceDescription.Albedo = ( _BaseColor * 0.5 ).rgb;
				...
				surfaceDescription.Emission = ( ( 1.0 - 0.5 ) * SAMPLE_TEXTURECUBE( _Cubemap, sampler_Cubemap, worldRefl9 ) ).rgb;
...
/*ASEBEGIN
Version=18920
303;172;1497;869;1335.74;434.2487;1;True;False
...
Node;AmplifyShaderEditor.ColorNode;31;-653.2405,-390.7487;Inherit;False;Property;_BaseColor;Base Color;4;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;29;-75.54871,102.179;Inherit;False;Property;_Float1;Float 1;2;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;30;-96.24048,242.2513;Inherit;False;Property;_Smoothness;Smoothness;3;0;Create;True;0;0;0;False;0;False;0;0.7647059;0;1;0;1;FLOAT;0
...
WireConnection;18;4;29;0
WireConnection;18;6;7;0
WireConnection;18;7;30;0
ASEEND*/
//CHKSM=C6E0C781E4365209C40DDBD01EE817634F5CA58C