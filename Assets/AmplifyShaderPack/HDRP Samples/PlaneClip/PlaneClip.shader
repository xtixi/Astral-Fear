...
Shader "AmplifyShaderPack/HDRP/PlaneClip/PlaneClip"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				surfaceDescription.Albedo = ( scaledFace15 * tex2D( _Textured_Course_AlbedoTransparency, uv_Textured_Course_AlbedoTransparency ) ).rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float scaledFace15 = (isFrontFace*0.5 + 0.5);
				float2 uv_Textured_Course_AlbedoTransparency = packedInput.ase_texcoord.xy * _Textured_Course_AlbedoTransparency_ST.xy + _Textured_Course_AlbedoTransparency_ST.zw;
...
/*ASEBEGIN
Version=18920
303;172;1497;869;287.5891;327.284;1.3;True;False
...
ASEEND*/
//CHKSM=9BC40D6556943CA925B0BFBFAE03AD0DBE084BF3