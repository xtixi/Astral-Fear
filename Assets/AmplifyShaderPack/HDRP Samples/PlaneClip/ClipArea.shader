...
Shader "AmplifyShaderPack/HDRP/PlaneClip/ClipArea"
{
	Properties
	{
		...
		_EmissionIntensity2("Emission Intensity", Float) = 0
		[ASEEnd]_EmissionWeight2("Emission Weight", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float screenDepth37 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				...
				float3 hdEmission89 = ASEGetEmissionHDRColor(( _Color * _Intensity * temp_output_46_0 ).rgb,_EmissionIntensity2,_EmissionWeight2,GetInverseCurrentExposureMultiplier());
				...
				float2 temp_output_11_0_g2 = ( abs( (frac( (packedInput.ase_texcoord5.xy*temp_cast_2 + float2( 0,0 )) )*2.0 + -1.0) ) - appendResult10_g2 );
				...
				surfaceDescription.Emission = hdEmission89;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 temp_cast_0 = (-0.5).xx;
				float2 texCoord48 = packedInput.ase_texcoord.xy * float2( 1,1 ) + temp_cast_0;
				...
				float temp_output_2_0_g1 = _GridSize;
				float2 appendResult10_g2 = (float2(temp_output_2_0_g1 , temp_output_2_0_g1));
				float2 temp_output_11_0_g2 = ( abs( (frac( (packedInput.ase_texcoord.xy*temp_cast_2 + float2( 0,0 )) )*2.0 + -1.0) ) - appendResult10_g2 );
				float2 break16_g2 = ( 1.0 - ( temp_output_11_0_g2 / fwidth( temp_output_11_0_g2 ) ) );
		...
		Pass
		{
					...
					)
			{
				...
				float2 temp_cast_0 = (-0.5).xx;
				float2 texCoord48 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + temp_cast_0;
				...
				float temp_output_2_0_g1 = _GridSize;
				float2 appendResult10_g2 = (float2(temp_output_2_0_g1 , temp_output_2_0_g1));
				float2 temp_output_11_0_g2 = ( abs( (frac( (packedInput.ase_texcoord1.xy*temp_cast_1 + float2( 0,0 )) )*2.0 + -1.0) ) - appendResult10_g2 );
				float2 break16_g2 = ( 1.0 - ( temp_output_11_0_g2 / fwidth( temp_output_11_0_g2 ) ) );
		...
		Pass
		{
					...
					)
			{
				...
				float temp_output_2_0_g1 = _GridSize;
				float2 appendResult10_g2 = (float2(temp_output_2_0_g1 , temp_output_2_0_g1));
				float2 temp_output_11_0_g2 = ( abs( (frac( (packedInput.ase_texcoord3.xy*temp_cast_1 + float2( 0,0 )) )*2.0 + -1.0) ) - appendResult10_g2 );
				float2 break16_g2 = ( 1.0 - ( temp_output_11_0_g2 / fwidth( temp_output_11_0_g2 ) ) );
		...
		Pass
		{
						...
						)
			{
				...
				float temp_output_2_0_g1 = _GridSize;
				float2 appendResult10_g2 = (float2(temp_output_2_0_g1 , temp_output_2_0_g1));
				float2 temp_output_11_0_g2 = ( abs( (frac( (packedInput.ase_texcoord7.xy*temp_cast_2 + float2( 0,0 )) )*2.0 + -1.0) ) - appendResult10_g2 );
				float2 break16_g2 = ( 1.0 - ( temp_output_11_0_g2 / fwidth( temp_output_11_0_g2 ) ) );
...
/*ASEBEGIN
Version=18920
303;172;1497;869;1096.887;503.4688;1.228918;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;88;-468.3855,-148.2921;Inherit;False;Property;_EmissionWeight2;Emission Weight;8;0;Create;True;0;0;0;False;0;False;0;1.93;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;87;-495.209,-226.053;Inherit;False;Property;_EmissionIntensity2;Emission Intensity;7;0;Create;True;0;0;0;False;0;False;0;3.21;0;0;0;1;FLOAT;0
...
WireConnection;75;6;89;0
WireConnection;75;9;71;0
ASEEND*/
//CHKSM=DF15BA8CA7E9C5FA486A2EA15E16337161D899FD