...
Shader "AmplifyShaderPack/HDRP/Triplanar"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float3 lerpResult284 = lerp( ( ( ( UnpackNormalScale( SAMPLE_TEXTURE2D( _TriplanarNormal, sampler_TriplanarNormal, appendResult332 ), 1.0f ) * BlendComponents147.x ) + ( UnpackNormalScale( SAMPLE_TEXTURE2D( _TriplanarNormal, sampler_TriplanarNormal, appendResult331 ), 1.0f ) * BlendComponents147.y ) ) + ( UnpackNormalScale( SAMPLE_TEXTURE2D( _TriplanarNormal, sampler_TriplanarNormal, appendResult330 ), 1.0f ) * BlendComponents147.z ) ) , UnpackNormalScale( SAMPLE_TEXTURE2D( _TopNormal, sampler_TopNormal, uv_TopNormal ), 1.0f ) , pow( saturate( ( normalWS.y + _CoverageAmount ) ) , _CoverageFalloff ));
				...
				float4 lerpResult105 = lerp( ( ( ( SAMPLE_TEXTURE2D( _TriplanarAlbedo, sampler_TriplanarAlbedo, appendResult336 ) * BlendComponents147.x ) + ( SAMPLE_TEXTURE2D( _TriplanarAlbedo, sampler_TriplanarAlbedo, appendResult335 ) * BlendComponents147.y ) ) + ( SAMPLE_TEXTURE2D( _TriplanarAlbedo, sampler_TriplanarAlbedo, appendResult334 ) * BlendComponents147.z ) ) , SAMPLE_TEXTURE2D( _TopAlbedo, sampler_TopAlbedo, appendResult333 ) , pow( saturate( ( lerpResult186 + _CoverageAmount ) ) , temp_cast_4 ).y);
...
/*ASEBEGIN
Version=18920
303;172;1497;869;1172.707;-1510.991;1;True;False
...
ASEEND*/
//CHKSM=0B6A7B0AAC4D39DCF57A58D51F67911AC85FFD03