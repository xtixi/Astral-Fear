...
Shader "AmplifyShaderPack/HDRP/Tessellation"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 uv_Heighmap = inputMesh.ase_texcoord.xy * _Heighmap_ST.xy + _Heighmap_ST.zw;
				...
				#endif
				float3 vertexValue = ( ( ( SAMPLE_TEXTURE2D_LOD( _Heighmap, sampler_Heighmap, uv_Heighmap, 1.0 ) * float4( inputMesh.normalOS , 0.0 ) ) * _Displacement ) * SAMPLE_TEXTURE2D_LOD( _Mask, sampler_Mask, uv_Mask, 0.0 ) ).rgb;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float2 uv_Heighmap = inputMesh.uv0.xy * _Heighmap_ST.xy + _Heighmap_ST.zw;
...
/*ASEBEGIN
Version=18920
303;172;1497;869;1472.923;-27.1905;1.3;True;False
...
WireConnection;7;4;19;0
WireConnection;7;8;20;0
WireConnection;7;11;22;0
ASEEND*/
//CHKSM=C03487ADD8E20D94343035FD53CC539FC7D587EA