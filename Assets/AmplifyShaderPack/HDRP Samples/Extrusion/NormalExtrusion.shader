...
Shader "AmplifyShaderPack/HDRP/NormalExtrusion"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				#endif
				float3 vertexValue = ( inputMesh.normalOS * max( ( sin( ( ( inputMesh.positionOS.y + ( _TimeParameters.x * 3 ) ) / _ExtrusionPoint ) ) / _ExtrusionAmount ) , 0.0 ) );
...
/*ASEBEGIN
Version=18920
303;172;1497;869;2007.69;267.9883;1;True;False
...
ASEEND*/
//CHKSM=F1BBCD56ECFDCD9588EBBB759241BBD1C650C8DD