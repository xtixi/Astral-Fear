...
Shader "AmplifyShaderPack/HDRP/Material Types/Standard"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_BaseColor1("Base Color", Color) = (0,0,0,0)
		_Smoothness1("Smoothness", Range( 0 , 1)) = 0
		[ASEEnd]_Metalicness("Metalicness", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				surfaceDescription.Albedo = _BaseColor1.rgb;
				surfaceDescription.Normal = float3( 0, 0, 1 );
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = _Metalicness;
...
/*ASEBEGIN
Version=18920
303;172;1497;869;690.2091;397.7279;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;40;-15.64392,53.29749;Inherit;False;Property;_Smoothness1;Smoothness;1;0;Create;True;0;0;0;False;0;False;0;0.6647059;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;39;0.9231544,-367.0454;Inherit;False;Property;_BaseColor1;Base Color;0;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,0.6627451,0.1647058,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;41;-15.64392,-26.85316;Inherit;False;Property;_Metalicness;Metalicness;2;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
WireConnection;28;4;41;0
WireConnection;28;7;40;0
ASEEND*/
//CHKSM=431797743F2DC139F0998C562578179D89BC73A8