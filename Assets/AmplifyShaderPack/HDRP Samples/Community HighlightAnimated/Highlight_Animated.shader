...
Shader "AmplifyShaderPack/HDRP/Highlight Animated"
{
	Properties
	{
		...
		[ASEEnd][Toggle]_Highlighted("Highlighted", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			TEXTURE2D(_Oclussion);
			SAMPLER(sampler_Oclussion);
						...
						)
			{
				...
				float4 Albedo65 = ( _Color * SAMPLE_TEXTURE2D( _Albedo, sampler_Albedo, texCoord51 ) );
				
				float3 Normal67 = UnpackNormalScale( SAMPLE_TEXTURE2D( _Normal, sampler_Normal, texCoord51 ), 1.0f );
				
				float4 Emision75 = SAMPLE_TEXTURE2D( _Emission, sampler_Emission, texCoord51 );
				...
				float3 hdEmission152 = ASEGetEmissionHDRColor(Final_Emision114.rgb,_EmissionIntensity,_EmissionWeight,GetInverseCurrentExposureMultiplier());
				
				float4 Oclussion86 = SAMPLE_TEXTURE2D( _Oclussion, sampler_Oclussion, texCoord51 );
				
				surfaceDescription.Albedo = Albedo65.rgb;
				...
				surfaceDescription.Emission = hdEmission152;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 texCoord51 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float4 Albedo65 = ( _Color * SAMPLE_TEXTURE2D( _Albedo, sampler_Albedo, texCoord51 ) );
...
/*ASEBEGIN
Version=18920
303;172;1497;869;2241.114;61.82227;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;128;-1740.517,-840.847;Float;False;Property;_HighlightSpeed;Highlight Speed;9;0;Create;True;0;0;0;False;0;False;60;141;0;200;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;55;-3003.912,380.0851;Float;False;Property;_HighlightColor;Highlight Color;5;0;Create;True;0;0;0;False;0;False;0.7065311,0.9705882,0.9596617,1;0.4801975,0.7249915,0.9339623,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ToggleSwitchNode;111;-1819.132,391.7312;Float;False;Property;_Highlighted;Highlighted;11;0;Create;True;0;0;0;False;0;False;0;True;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;63;-2603.194,-1064.421;Float;False;Property;_Color;Color;0;0;Create;True;0;0;0;False;0;False;0.9044118,0.6640914,0.03325041,0;0.8569391,1,0.07075468,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;151;-484.2242,-594.9389;Inherit;False;Property;_EmissionWeight;Emission Weight;10;0;Create;True;0;0;0;False;0;False;0;2.01;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;150;-494.1398,-673.9933;Inherit;False;Property;_EmissionIntensity;Emission Intensity;8;0;Create;True;0;0;0;False;0;False;0;27.27;0;0;0;1;FLOAT;0
...
WireConnection;139;6;152;0
WireConnection;139;8;76;0
ASEEND*/
//CHKSM=D4132824A46EDED4DF432D71B28D50B95168D058