...
Shader "AmplifyShaderPack/HDRP/GlintSparkle"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				surfaceDescription.Emission = ( ( _GlintColor * pow( saferPower487 , 5.0 ) * fresnelNode400 * _Brightness ) + ( _SparkleColor * smoothstepResult364 * _SparklesBrightness * fresnelNode536 ) + ( _BodyGlow * fresnelNode370 ) ).rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				#if defined(_DIRECTION_X)
				float staticSwitch495 = packedInput.ase_texcoord1.xyz.x;
				#elif defined(_DIRECTION_Y)
				float staticSwitch495 = packedInput.ase_texcoord1.xyz.y;
				#elif defined(_DIRECTION_Z)
				float staticSwitch495 = packedInput.ase_texcoord1.xyz.z;
				#else
				float staticSwitch495 = packedInput.ase_texcoord1.xyz.y;
				#endif
				#ifdef _INVERTDIRECTION_ON
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				float4 ase_clipPos = TransformWorldToHClip( TransformObjectToWorld(inputMesh.positionOS));
				float4 screenPos = ComputeScreenPos( ase_clipPos , _ProjectionParams.x );
				outputPackedVaryingsMeshToPS.ase_texcoord10 = screenPos;
...
/*ASEBEGIN
Version=18920
303;172;1497;869;-4489.234;754.1943;1;True;False
...
WireConnection;583;0;292;0
WireConnection;583;1;565;0
WireConnection;583;4;345;0
WireConnection;583;6;374;0
WireConnection;583;7;345;0
ASEEND*/
//CHKSM=DE5FDF5FE1285E10726249867BAB22E7594AB558