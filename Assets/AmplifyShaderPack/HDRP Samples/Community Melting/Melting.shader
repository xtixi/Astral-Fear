...
Shader "AmplifyShaderPack/HDRP/Melting"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			#endif
			CBUFFER_END
			TEXTURE2D(_DisplaceNoise);
			SAMPLER(sampler_DisplaceNoise);
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float4 tex2DNode58 = SAMPLE_TEXTURE2D_LOD( _DisplaceNoise, sampler_DisplaceNoise, ( appendResult61 * _NoiseScale ), 0.0 );
						...
						)
			{
				...
				float4 tex2DNode58 = SAMPLE_TEXTURE2D( _DisplaceNoise, sampler_DisplaceNoise, ( appendResult61 * _NoiseScale ) );
				float temp_output_72_0 = ( ( tex2DNode58.g * _NoiseMultiply ) + (( _AnimatedMelt )?( ( ( sin( _TimeParameters.x * 0.5 ) * _Oscillation ) + _Limit ) ):( _ManualControl )) );
				...
				float2 texCoord145 = packedInput.ase_texcoord6.xy * temp_cast_1 + float2( 0,0 );
				...
				float3 hdEmission144 = ASEGetEmissionHDRColor(( lerpResult56 * SmoothStep1110 ).rgb,_EmissionIntensity,_EmissionWeight,GetInverseCurrentExposureMultiplier());
				
				surfaceDescription.Albedo = ( _BaseColor * saturate( ( 1.0 - ( 5.0 * SmoothStep1110 ) ) ) ).rgb;
				surfaceDescription.Normal = UnpackNormalScale( SAMPLE_TEXTURE2D( _BaseNormal, sampler_BaseNormal, texCoord145 ), 1.0f );
				...
				surfaceDescription.Emission = hdEmission144;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 appendResult61 = (float2(( packedInput.ase_texcoord.xyz.x + (( _AnimatedMelt )?( ( ( sin( _TimeParameters.x * 0.5 ) * _Oscillation ) + _Limit ) ):( _ManualControl )) ) , packedInput.ase_texcoord.xyz.z));
				float4 tex2DNode58 = SAMPLE_TEXTURE2D( _DisplaceNoise, sampler_DisplaceNoise, ( appendResult61 * _NoiseScale ) );
				float temp_output_72_0 = ( ( tex2DNode58.g * _NoiseMultiply ) + (( _AnimatedMelt )?( ( ( sin( _TimeParameters.x * 0.5 ) * _Oscillation ) + _Limit ) ):( _ManualControl )) );
				float Vertex1106 = packedInput.ase_texcoord.xyz.y;
				float smoothstepResult92 = smoothstep( ( temp_output_72_0 - 0.5 ) , ( temp_output_72_0 + 0.5 ) , Vertex1106);
				float SmoothStep1110 = smoothstepResult92;
				
				float2 temp_cast_1 = (2.0).xx;
				float2 texCoord145 = packedInput.ase_texcoord1.xy * temp_cast_1 + float2( 0,0 );
		...
		Pass
		{
					...
					)
			{
				...
				float2 texCoord145 = packedInput.ase_texcoord3.xy * temp_cast_0 + float2( 0,0 );
		...
		Pass
		{
						...
						)
			{
				...
				float2 temp_cast_1 = (2.0).xx;
				float2 texCoord145 = packedInput.ase_texcoord8.xy * temp_cast_1 + float2( 0,0 );
...
/*ASEBEGIN
Version=18920
303;172;1497;869;1144.933;351.6765;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;123;-3324.453,832.0427;Float;False;Property;_ManualControl;Manual Control;14;0;Create;True;0;0;0;False;0;False;0;2.07;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;124;-2988.804,964.5943;Float;False;Property;_AnimatedMelt;Animated Melt;13;0;Create;True;0;0;0;False;0;False;1;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;121;-1974.133,1046.565;Float;False;Property;_NoiseMultiply;Noise Multiply;12;0;Create;True;0;0;0;False;0;False;0;2.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;142;-166.2733,361.5146;Inherit;False;Property;_EmissionWeight;Emission Weight;10;0;Create;True;0;0;0;False;0;False;0;4.73;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;143;-185.4456,233.4104;Inherit;False;Property;_EmissionIntensity;Emission Intensity;8;0;Create;True;0;0;0;False;0;False;0;3.25;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;116;81.77899,41.52697;Float;False;Property;_Metallic;Metallic;11;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.HDEmissionNode;144;158.2913,130.464;Inherit;False;Luminance;False;3;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT3;0
...
WireConnection;131;0;47;0
WireConnection;131;1;122;0
WireConnection;131;4;116;0
WireConnection;131;6;144;0
WireConnection;131;7;115;0
WireConnection;131;11;83;0
ASEEND*/
//CHKSM=0C77334D2E78577FD6011A49E600E3C6E10EB382