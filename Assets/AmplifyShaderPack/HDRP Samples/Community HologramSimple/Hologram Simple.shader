...
Shader "AmplifyShaderPack/HDRP/Hologram Simple"
{
	Properties
	{
		...
		[ASEEnd]_EmissionWeight("Emission Weight", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			#endif
			CBUFFER_END
			TEXTURE2D(_RimNormalMap);
			SAMPLER(sampler_RimNormalMap);
						...
						)
			{
				...
				float2 temp_cast_0 = (( ( ase_worldPos.z / 100.0 ) * ( _TimeParameters.x * 0.05 ) )).xx;
				...
				float dotResult55 = dot( UnpackNormalScale( SAMPLE_TEXTURE2D( _RimNormalMap, sampler_RimNormalMap, ( ( ( Speed156 / 1000.0 ) * _Time ) + float4( texCoord158, 0.0 , 0.0 ) ).xy ), 1.0f ) , normalizeResult57 );
...
/*ASEBEGIN
Version=18920
303;172;1497;869;2975.348;1665.296;3.286381;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;183;-562.6326,-191.9325;Inherit;False;Property;_EmissionWeight;Emission Weight;8;0;Create;True;0;0;0;False;0;False;0;4.9;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;182;-531.9745,-271.6299;Inherit;False;Property;_EmissionIntensity;Emission Intensity;7;0;Create;True;0;0;0;False;0;False;0;4.87;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;49;-398.1664,-91.16708;Float;False;Property;_Opacity;Opacity;3;0;Create;True;0;0;0;False;0;False;0.5;0.2941177;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;66;-1368.539,379.8929;Inherit;False;32;HologramColor;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.HDEmissionNode;184;-229.5256,-313.356;Inherit;False;Luminance;False;3;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=029EA5212F5203E9396FF7BA58539FBC52F7D7A9