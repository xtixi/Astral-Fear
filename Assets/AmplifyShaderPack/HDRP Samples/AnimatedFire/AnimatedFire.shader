...
Shader "AmplifyShaderPack/HDRP/AnimatedFireShaderFunction"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float3 hdEmission38 = ASEGetEmissionHDRColor(( ( SAMPLE_TEXTURE2D( _BurnMask, sampler_BurnMask, uv_BurnMask ) * SAMPLE_TEXTURE2D( _FireTexture, sampler_FireTexture, panner2_g3 ) ) * ( _FireIntensity * ( _TimeParameters.y + 1.5 ) ) ).rgb,_EmissionIntensity,_EmissionWeight,GetInverseCurrentExposureMultiplier());
				
				surfaceDescription.Albedo = SAMPLE_TEXTURE2D( _Albedo, sampler_Albedo, texCoord4 ).rgb;
				surfaceDescription.Normal = UnpackNormalScale( SAMPLE_TEXTURE2D( _Normals, sampler_Normals, texCoord4 ), 1.0f );
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = 0;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = SAMPLE_TEXTURE2D( _Specular, sampler_Specular, texCoord4 ).rgb;
				#endif

				surfaceDescription.Emission = hdEmission38;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv_BurnMask = packedInput.ase_texcoord.xy * _BurnMask_ST.xy + _BurnMask_ST.zw;
				float2 panner2_g3 = ( ( _TimeParameters.x * 0.05 ) * float2( -1,0 ) + texCoord4);
				float3 hdEmission38 = ASEGetEmissionHDRColor(( ( SAMPLE_TEXTURE2D( _BurnMask, sampler_BurnMask, uv_BurnMask ) * SAMPLE_TEXTURE2D( _FireTexture, sampler_FireTexture, panner2_g3 ) ) * ( _FireIntensity * ( _TimeParameters.y + 1.5 ) ) ).rgb,_EmissionIntensity,_EmissionWeight,GetInverseCurrentExposureMultiplier());
...
/*ASEBEGIN
Version=18920
303;172;1497;869;1856.874;180.6005;1.706415;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;40;-392.7699,292.9298;Inherit;False;Property;_EmissionWeight;Emission Weight;8;0;Create;True;0;0;0;False;0;False;0;2.01;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;41;-512.2248,108.1856;Inherit;False;Burn Effect;0;;3;ea271133a2d84723abf43bf30fa91cbb;0;2;12;FLOAT;0;False;14;FLOAT2;0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;39;-395.8335,208.7362;Inherit;False;Property;_EmissionIntensity;Emission Intensity;7;0;Create;True;0;0;0;False;0;False;0;27.27;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.HDEmissionNode;38;-34.92599,31.84482;Inherit;False;Luminance;False;3;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT3;0
...
WireConnection;27;5;16;0
WireConnection;27;6;38;0
WireConnection;27;7;15;0
ASEEND*/
//CHKSM=FE0C30259DEAC3CBB67CCFABF33B08A40D599430