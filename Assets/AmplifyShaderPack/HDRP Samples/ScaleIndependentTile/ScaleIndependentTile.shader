...
Shader "AmplifyShaderPack/HDRP/ScaleIndependentTile"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				surfaceDescription.Albedo = SAMPLE_TEXTURE2D( _Albedo, sampler_Albedo, texCoord15 ).rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 appendResult5 = (float2(break3.x , break3.y));
				float2 XYScale20 = appendResult5;
				float2 texCoord15 = packedInput.ase_texcoord.xy * ( ( ( ZYScale18 * break7.x ) + ( break7.y * XZScale19 ) + ( break7.z * XYScale20 ) ) * _TilingScale ) + _TilingOffset;
...
/*ASEBEGIN
Version=18920
303;172;1497;869;708.0546;350.2899;1;True;False
...
ASEEND*/
//CHKSM=B615AF9C290FCA53EA287F7FBD89F51B1E261C09