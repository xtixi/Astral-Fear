...
Shader "AmplifyShaderPack/HDRP/ScreenSpaceCurvature"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				surfaceDescription.Color = ( ( ( ( cross( ( ase_worldNormal - temp_output_2_0 ) , ( ase_worldNormal + temp_output_2_0 ) ).y - cross( ( ase_worldNormal - temp_output_7_0 ) , ( ase_worldNormal + temp_output_7_0 ) ).x ) * _ScaleFactor ) / length( packedInput.ase_texcoord2.xyz ) ) + float3(0.5,0.5,0.5) );
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				surfaceDescription.Color = ( ( ( ( cross( ( ase_worldNormal - temp_output_2_0 ) , ( ase_worldNormal + temp_output_2_0 ) ).y - cross( ( ase_worldNormal - temp_output_7_0 ) , ( ase_worldNormal + temp_output_7_0 ) ).x ) * _ScaleFactor ) / length( packedInput.ase_texcoord1.xyz ) ) + float3(0.5,0.5,0.5) );
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = 1;
				surfaceDescription.AlphaClipThreshold =  _AlphaCutoff;
...
/*ASEBEGIN
Version=18920
303;172;1497;869;1702.851;490.7404;1.668976;True;False
...
ASEEND*/
//CHKSM=D93BB89B6BD2A3203524F0BEB5A1F394125EBEF1