...
Shader "AmplifyShaderPack/HDRP/DissolveBurn"
{
	Properties
	{
		...
		[ASEEnd][Toggle]_AnimateDissolve("Animate Dissolve", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			TEXTURE2D(_DisolveGuide);
			SAMPLER(sampler_DisolveGuide);
			TEXTURE2D(_BurnRamp);
						...
						)
			{
				...
				float temp_output_73_0 = ( (-0.6 + (( 1.0 - (( _AnimateDissolve )?( saturate( sin( _TimeParameters.x * 0.25 ) ) ):( _DissolveAmount )) ) - 0.0) * (0.6 - -0.6) / (1.0 - 0.0)) + SAMPLE_TEXTURE2D( _DisolveGuide, sampler_DisolveGuide, uv_DisolveGuide ).r );
				...
				float3 hdEmission145 = ASEGetEmissionHDRColor(( _Color0 * ( temp_output_130_0 * SAMPLE_TEXTURE2D( _BurnRamp, sampler_BurnRamp, appendResult115 ) ) ).rgb,_EmissionIntensity,_EmissionWeight,GetInverseCurrentExposureMultiplier());
				
				surfaceDescription.Albedo = SAMPLE_TEXTURE2D( _Albedo, sampler_Albedo, uv_Albedo ).rgb;
				surfaceDescription.Normal = UnpackNormalScale( SAMPLE_TEXTURE2D( _Normal, sampler_Normal, uv_Normal ), 1.0f );
				...
				surfaceDescription.Emission = hdEmission145;
				surfaceDescription.Smoothness = 0.5;
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = saturate( temp_output_73_0 );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv_DisolveGuide = packedInput.ase_texcoord.xy * _DisolveGuide_ST.xy + _DisolveGuide_ST.zw;
				float temp_output_73_0 = ( (-0.6 + (( 1.0 - (( _AnimateDissolve )?( saturate( sin( _TimeParameters.x * 0.25 ) ) ):( _DissolveAmount )) ) - 0.0) * (0.6 - -0.6) / (1.0 - 0.0)) + SAMPLE_TEXTURE2D( _DisolveGuide, sampler_DisolveGuide, uv_DisolveGuide ).r );
				float clampResult113 = clamp( (-4.0 + (temp_output_73_0 - 0.0) * (4.0 - -4.0) / (1.0 - 0.0)) , 0.0 , 1.0 );
				float temp_output_130_0 = ( 1.0 - clampResult113 );
				float2 appendResult115 = (float2(temp_output_130_0 , 0.0));
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_DisolveGuide = packedInput.ase_texcoord1.xy * _DisolveGuide_ST.xy + _DisolveGuide_ST.zw;
				float temp_output_73_0 = ( (-0.6 + (( 1.0 - (( _AnimateDissolve )?( saturate( sin( _TimeParameters.x * 0.25 ) ) ):( _DissolveAmount )) ) - 0.0) * (0.6 - -0.6) / (1.0 - 0.0)) + SAMPLE_TEXTURE2D( _DisolveGuide, sampler_DisolveGuide, uv_DisolveGuide ).r );
...
/*ASEBEGIN
Version=18920
303;172;1497;869;1487.556;-270.6041;1;True;False
...
Node;AmplifyShaderEditor.ToggleSwitchNode;159;-856.0557,637.1041;Inherit;False;Property;_AnimateDissolve;Animate Dissolve;9;0;Create;True;0;0;0;False;0;False;1;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;129;-892.9326,49.09825;Inherit;False;1301.169;453.1093;Burn Effect - Emission;10;155;126;114;150;149;115;130;113;112;156;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;126;-170.7431,143.3325;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;155;-5.226402,88.97025;Inherit;False;Property;_Color0;Color 0;8;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,0.3864341,0.06132074,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;149;-98.41885,296.2239;Inherit;False;Property;_EmissionIntensity;Emission Intensity;6;0;Create;True;0;0;0;False;0;False;0;15.42;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;132;484.9881,-3.141543;Inherit;False;765.1592;493.9802;Created by The Four Headed Cat @fourheadedcat - www.twitter.com/fourheadedcat;2;133;145;;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;150;-96.35526,387.4175;Inherit;False;Property;_EmissionWeight;Emission Weight;7;0;Create;True;0;0;0;False;0;False;0;9.92;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.HDEmissionNode;145;522.887,125.9241;Inherit;False;Luminance;False;3;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT3;0
...
WireConnection;133;6;145;0
WireConnection;133;9;154;0
WireConnection;133;10;144;0
ASEEND*/
//CHKSM=18763599673D3CD789F790FFDDBF6878859F7648