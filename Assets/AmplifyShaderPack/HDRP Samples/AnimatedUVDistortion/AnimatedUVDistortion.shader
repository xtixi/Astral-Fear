...
Shader "AmplifyShaderPack/HDRP/AnimatedUVDistort"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float3 unpack6 = UnpackNormalScale( SAMPLE_TEXTURE2D( _DistortTexture, sampler_DistortTexture, uv_DistortTexture ), _UVDistortIntensity );
				...
				float4 temp_output_20_0 = ( _TintColor * ( SAMPLE_TEXTURE2D( _MainTexture, sampler_MainTexture, ( float3( texCoord9 ,  0.0 ) + tex2DNode6 ).xy ) * SAMPLE_TEXTURE2D( _MainTexture, sampler_MainTexture, ( float3( texCoord18 ,  0.0 ) + tex2DNode6 ).xy ) ) );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float mulTime10 = _TimeParameters.x * _Speed;
				float2 panner11 = ( mulTime10 * float2( -1,-1 ) + float2( 0,0 ));
				float2 texCoord9 = packedInput.ase_texcoord.xy * float2( 1,1 ) + panner11;
				float2 uv_DistortTexture = packedInput.ase_texcoord.xy * _DistortTexture_ST.xy + _DistortTexture_ST.zw;
				float3 unpack6 = UnpackNormalScale( SAMPLE_TEXTURE2D( _DistortTexture, sampler_DistortTexture, uv_DistortTexture ), _UVDistortIntensity );
				unpack6.z = lerp( 1, unpack6.z, saturate(_UVDistortIntensity) );
				float3 tex2DNode6 = unpack6;
				float mulTime15 = _TimeParameters.x * _Speed;
				float2 panner17 = ( mulTime15 * float2( 1,0.5 ) + float2( 0,0 ));
				float2 texCoord18 = packedInput.ase_texcoord.xy * float2( 1,1 ) + panner17;
				float4 temp_output_20_0 = ( _TintColor * ( SAMPLE_TEXTURE2D( _MainTexture, sampler_MainTexture, ( float3( texCoord9 ,  0.0 ) + tex2DNode6 ).xy ) * SAMPLE_TEXTURE2D( _MainTexture, sampler_MainTexture, ( float3( texCoord18 ,  0.0 ) + tex2DNode6 ).xy ) ) );
...
/*ASEBEGIN
Version=18920
303;172;1497;869;2519.234;257.3339;1.013322;True;False
...
Node;AmplifyShaderEditor.SamplerNode;6;-1558.098,90.11827;Inherit;True;Property;_DistortTexture;Distort Texture;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;white;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;24;6;20;0
WireConnection;24;7;35;0
ASEEND*/
//CHKSM=9E4000137D2B01AA61943A058E3925B8B1D2F958