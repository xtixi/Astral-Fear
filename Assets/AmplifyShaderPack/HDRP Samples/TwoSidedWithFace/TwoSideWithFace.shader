...
Shader "AmplifyShaderPack/HDRP/TwoSideWithFace"
{
	Properties
	{
		...
		[ASEEnd]_MaskClipValue1("Mask Clip Value", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			#endif
			CBUFFER_END
			TEXTURE2D(_FrontAlbedo);
			SAMPLER(sampler_FrontAlbedo);
			TEXTURE2D(_BackAlbedo);
			SAMPLER(sampler_BackAlbedo);
			TEXTURE2D(_FrontNormalMap);
			SAMPLER(sampler_FrontNormalMap);
			TEXTURE2D(_BackNormalMap);
			SAMPLER(sampler_BackNormalMap);
			TEXTURE2D(_Mask);
						...
						)
			{
				...
				float4 switchResult2 = (((isFrontFace>0)?(( SAMPLE_TEXTURE2D( _FrontAlbedo, sampler_FrontAlbedo, texCoord14 ) * _FrontColor )):(( SAMPLE_TEXTURE2D( _BackAlbedo, sampler_BackAlbedo, texCoord14 ) * _BackColor ))));
				
				float3 switchResult3 = (((isFrontFace>0)?(UnpackNormalScale( SAMPLE_TEXTURE2D( _FrontNormalMap, sampler_FrontNormalMap, texCoord14 ), 1.0f )):(UnpackNormalScale( SAMPLE_TEXTURE2D( _BackNormalMap, sampler_BackNormalMap, texCoord14 ), 1.0f ))));
				
				float2 uv_Mask = packedInput.ase_texcoord5.xy * _Mask_ST.xy + _Mask_ST.zw;
				
				surfaceDescription.Albedo = switchResult2.rgb;
				...
				surfaceDescription.Alpha = SAMPLE_TEXTURE2D( _Mask, sampler_Mask, uv_Mask ).a;

				#ifdef _ALPHATEST_ON
				surfaceDescription.AlphaClipThreshold = _MaskClipValue1;
				#endif
		...
		Pass
		{
				...
				)
			{
				...
				SmoothSurfaceDescription surfaceDescription = (SmoothSurfaceDescription)0;
				float2 texCoord14 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float3 switchResult3 = (((ase_vface>0)?(UnpackNormalScale( SAMPLE_TEXTURE2D( _FrontNormalMap, sampler_FrontNormalMap, texCoord14 ), 1.0f )):(UnpackNormalScale( SAMPLE_TEXTURE2D( _BackNormalMap, sampler_BackNormalMap, texCoord14 ), 1.0f ))));
...
/*ASEBEGIN
Version=18920
303;172;1497;869;483.4464;335.7129;1;True;False
...
Node;AmplifyShaderEditor.ColorNode;7;-785,32;Float;False;Property;_BackColor;BackColor;6;0;Create;True;0;0;0;False;0;False;0,0,1,0;0,0.04080532,1,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;5;-785,-336;Float;False;Property;_FrontColor;FrontColor;3;0;Create;True;0;0;0;False;0;False;1,0.6691177,0.6691177,0;0.4113164,1,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;41;9;1;4
WireConnection;41;10;52;0
ASEEND*/
//CHKSM=963413497D1D0A745211A2F0296A8ECC49438781