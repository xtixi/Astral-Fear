...
Shader "AmplifyShaderPack/HDRP/OrientationBasedSprite"
{
	Properties
	{
		...
		_Rows("Rows", Float) = 0
		[ASEEnd]_AnimSpeed("Anim Speed", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				float2 texCoord29_g11 = inputMesh.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float2 vertexToFrag37_g11 = packedInput.ase_texcoord1.xy;
				float4 temp_output_634_0 = tex2D( _MainTex, vertexToFrag37_g11 );
				
				surfaceDescription.Color = (temp_output_634_0).rgb;
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 vertexToFrag37_g11 = packedInput.ase_texcoord.xy;
				float4 temp_output_634_0 = tex2D( _MainTex, vertexToFrag37_g11 );
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 vertexToFrag37_g11 = packedInput.ase_texcoord3.xy;
				float4 temp_output_634_0 = tex2D( _MainTex, vertexToFrag37_g11 );
...
/*ASEBEGIN
Version=18920
303;172;1497;869;-13544.94;105.4264;1.636947;True;False
...
WireConnection;635;2;624;0
WireConnection;635;6;642;0
ASEEND*/
//CHKSM=04837F91ED1C9B4CA554D468A3BD664E0E5D24B8