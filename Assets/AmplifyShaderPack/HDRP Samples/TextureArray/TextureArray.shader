...
Shader "AmplifyShaderPack/HDRP/TextureArray"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				surfaceDescription.Albedo = SAMPLE_TEXTURE2D_ARRAY( _TextureArrayAlbedo, sampler_TextureArrayAlbedo, uv_TextureArrayAlbedo,3.0 ).rgb;
				...
				surfaceDescription.Smoothness = ( SAMPLE_TEXTURE2D_ARRAY( _TextureArrayAlbedo, sampler_TextureArrayAlbedo, uv_TextureArrayAlbedo,0.0 ).r * _RoughScale );
				surfaceDescription.Occlusion = SAMPLE_TEXTURE2D_ARRAY( _TextureArrayAlbedo, sampler_TextureArrayAlbedo, uv_TextureArrayAlbedo,1.0 ).r;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_TextureArrayAlbedo = packedInput.ase_texcoord.xy;
				
				float2 uv_TextureArrayNormal = packedInput.ase_texcoord.xy;
				float3 unpack103 = UnpackNormalScale( SAMPLE_TEXTURE2D_ARRAY( _TextureArrayNormal, sampler_TextureArrayNormal, uv_TextureArrayNormal,0.0 ), _NormalScale );
				unpack103.z = lerp( 1, unpack103.z, saturate(_NormalScale) );
...
/*ASEBEGIN
Version=18920
303;172;1497;869;1307.869;358.6461;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;113;-553.9034,-373.3005;Float;False;Constant;_AlbedoIndex;Albedo Index;2;0;Create;True;0;0;0;False;0;False;3;3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;118;-304,240;Float;False;Property;_RoughScale;Rough Scale;3;0;Create;True;0;0;0;False;0;False;0.1;0.52;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=4DBC9F3FD83E8D80873277D028B5700CAAA0D760