...
namespace MD_Plugin
{
    //---Big up to all guys who provided advanced math resources and helped with implementation!
    //The code below is built from bunch of resources. It's well optimized and ready for practical use
    //Big thanks to mattatz, MarkGX, Baxid89, Cat-like-coding, Lucas C. Figueiredo, Luciano C. A. Pimenta and many more...
