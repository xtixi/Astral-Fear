...
public class MDM_RaycastEvent_Editor : ModifiersEditorController
{
    ...
    SerializedProperty ppLocalRay, ppGlobalRayDir;
    ...
    private void OnEnable()
    {
        ...
        ppLocalRay = serializedObject.FindProperty("ppLocalRay");
        ppGlobalRayDir = serializedObject.FindProperty("ppGlobalRayDir");
    }
    ...
    public override void OnInspectorGUI()
    {
        ...
        ppDraw_Property(ppLocalRay, "Local Ray");
        if(m.ppLocalRay == false)
            ppDraw_Property(ppGlobalRayDir, "Global Ray Direction");
