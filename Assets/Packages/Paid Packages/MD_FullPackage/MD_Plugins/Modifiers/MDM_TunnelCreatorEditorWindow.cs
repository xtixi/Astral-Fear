...
namespace MD_Plugin
{
    public class MDM_TunnelCreatorEditorWindow : EditorWindow
    {
        ...
        {
            MDM_TunnelCreatorEditorWindow newWin =
                (MDM_TunnelCreatorEditorWindow) EditorWindow.GetWindow(typeof(MDM_TunnelCreatorEditorWindow));
        ...
        private void OnGUI()
        {
            ...
            obj_UngroupTo =
                EditorGUILayout.ObjectField(
                    new GUIContent("Ungroup To", "Leave this field empty if the parent will be null"),
                    (Object) obj_UngroupTo, typeof(GameObject), true) as GameObject;
            ...
            {
                EditorGUILayout.HelpBox("To access nodes editor features, there must be more than 3 nodes...",
                    MessageType.Warning);
                ev();
                return;
            }
            ...
            switch (selectedEditorFeature)
            {
                case 1:
                    ...
                    obj2 = EditorGUILayout.ObjectField(new GUIContent("From Node"), (Object) obj2, typeof(GameObject),
                        true) as GameObject;
                    obj1 = EditorGUILayout.ObjectField(new GUIContent("To Node"), (Object) obj1, typeof(GameObject),
                        true) as GameObject;
                    EditorGUIUtility.labelWidth += 15;
                    ev();
                    bh();
                ...
                case 3:
                    ...
                    obj2 = EditorGUILayout.ObjectField(new GUIContent("Ending Node"), (Object) obj2, typeof(GameObject),
                        true) as GameObject;
                    obj1 = EditorGUILayout.ObjectField(new GUIContent("Starting Node"), (Object) obj1,
