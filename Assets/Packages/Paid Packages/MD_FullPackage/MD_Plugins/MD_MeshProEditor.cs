...
namespace MD_Plugin
{
    ...
    public class MD_MeshProEditor : MonoBehaviour 
    {
        ...
        public bool ppOptimizeMesh = true;
        ...
        public void MeshEditor_SmoothMesh(float Intensity = 0.5f)
        {
            ...
            for (int i = 0; i < 1; i++)
                workingMesh.vertices = MD_MeshUtilities.smoothing_HCFilter.HCFilter(sourceMesh.vertices, workingMesh.triangles, 0.0f, Intensity);
        ...
        public void MeshEditor_SubdivideMesh(int Level)
        {
            ...
            sourceMesh = new Mesh();
            sourceMesh = meshF.sharedMesh;
            MD_MeshUtilities.mesh_Subdivision.Subdivide(sourceMesh, Level);
