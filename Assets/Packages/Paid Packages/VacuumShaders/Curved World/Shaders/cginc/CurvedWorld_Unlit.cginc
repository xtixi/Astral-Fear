...
//Defines///////////////////////////////////////////////////////////////
#if !defined(V_CW_REFLECTIVE) && !defined(V_CW_IBL_CUBE) && !defined(V_CW_IBL_MATCAP)
	#ifdef _NORMALMAP
	#undef _NORMALMAP
	#endif
#endif
...
struct vInput
{
	...
	#if defined(V_CW_REFLECTIVE) || defined(V_CW_RIM) || defined(V_CW_IBL_CUBE) || defined(V_CW_IBL_MATCAP)
		float3 normal : NORMAL;
	#endif

	#if defined(V_CW_REFLECTIVE) || defined(V_CW_IBL_CUBE) || (defined(V_CW_IBL_MATCAP) && defined(_NORMALMAP))
...
struct vOutput
{
	...
	CURVEDWORLD_RANGE_FADE_COORDINATE(6)
};
...
{ 
	...
	#if defined(V_CW_REFLECTIVE) || defined(V_CW_IBL_CUBE)
	...
	#endif
	#if defined(V_CW_REFLECTIVE) || defined(V_CW_RIM)
...
fixed4 frag (vOutput i) : SV_Target
{
	...
	//Curved World Distance Fade
		...
		#if defined(V_CW_REFLECTIVE) && !defined(V_CW_IBL_MATCAP)
