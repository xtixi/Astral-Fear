...
Shader "Hidden/VacuumShaders/Curved World/One Directional Light/Opaque/Detail"
{
	...
	SubShader 
	{
		Tags { "RenderType"="CurvedWorld_Opaque" 
			   ...
			   "CurvedWorldAvailableOptions"="V_CW_USE_LIGHT_RAMP_TEXTURE;V_CW_REFLECTIVE;_EMISSION;V_CW_RIM;V_CW_FOG;_NORMALMAP;V_CW_SPECULAR_LOOKUP;V_CW_UNITY_AMBIENT;V_CW_PERVERTEX_LIGHT;VERTEX_COLOR;" 
			 } 
		LOD 200		
