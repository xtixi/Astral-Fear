...
Shader "VacuumShaders/Curved World/Particles/Standard Unlit"
{
    Properties
    {
    ...
    Category
    {
        SubShader
        {
            Tags { "RenderType"="CurvedWorld_Opaque" "IgnoreProjector"="True" "PreviewType"="Plane" "PerformanceChecks"="False" }
            ...
            Pass
            {
                ...
                #include "../cginc/UnityStandardParticleShadow.cginc"
                ENDCG
            }
            ...
            Pass
            {
                ...
                #include "../cginc/UnityStandardParticles.cginc"
                ENDCG
            }
        }
    }
    ...
    CustomEditor "CurvedWorld_StandardParticlesShaderGUI"
}
