...
{           
	...
	SubShader 
	{
		Tags { "RenderType"="CurvedWorld_Opaque" 
			   ...
			   "CurvedWorldAvailableOptions"="V_CW_REFLECTIVE;V_CW_IBL;_EMISSION;V_CW_RIM;V_CW_FOG;_NORMALMAP;VERTEX_COLOR;" 
			 } 
		LOD 100		     
	    ...
	    {                       
			...
			#pragma shader_feature _ V_CW_IBL_CUBE V_CW_IBL_MATCAP
